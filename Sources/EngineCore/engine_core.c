...
static MDTBFloat3 offset_outer_route_position(
    const MDTBOuterRouteNodeContext *route_context,
    MDTBFloat3 origin,
    float longitudinal_offset,
    float lateral_offset
);
static float outer_route_longitudinal_sign_for_block(const MDTBBlockDescriptor *block);
static MDTBFloat3 outer_route_continuity_pad_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_continuity_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_continuity_landmark_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_secondary_frontage_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_secondary_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_secondary_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_rear_edge_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_rear_edge_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_rear_edge_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_backlot_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_backlot_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_backlot_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_infill_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_infill_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_infill_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_inner_enclosure_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_inner_enclosure_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_inner_enclosure_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_core_backstop_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_core_backstop_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_core_backstop_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
...
static MDTBFloat3 outer_route_terminal_enclosure_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_terminal_enclosure_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_terminal_enclosure_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_yard_tail_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_yard_tail_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_yard_tail_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_tail_cap_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_tail_cap_pull_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
static MDTBFloat3 outer_route_tail_cap_staging_position(
    const MDTBBlockDescriptor *block,
    const MDTBOuterRouteNodeContext *route_context
);
...
static void refresh_traffic_occupancies(const MDTBEngineState *state) {
    ...
    if (state->active_block_index < g_block_count) {
        ...
        for (size_t index = 0u; index < g_block_count && outer_route_pressure_count < 6u; ++index) {
            ...
            float continuity_strength_scale = 0.60f;
            float continuity_pull_strength_scale = 0.54f;
            float secondary_strength_scale = 0.46f;
            float secondary_pull_strength_scale = 0.40f;
            float rear_edge_strength_scale = 0.34f;
            float rear_edge_pull_strength_scale = 0.30f;
            float backlot_strength_scale = 0.22f;
            float backlot_pull_strength_scale = 0.18f;
            float infill_strength_scale = 0.12f;
            float infill_pull_strength_scale = 0.10f;
            float inner_enclosure_strength_scale = 0.08f;
            ...
            float terminal_enclosure_strength_scale = 0.02f;
            float terminal_enclosure_pull_strength_scale = 0.015f;
            float yard_tail_strength_scale = 0.010f;
            float yard_tail_pull_strength_scale = 0.008f;
            float tail_cap_strength_scale = 0.006f;
            float tail_cap_pull_strength_scale = 0.004f;
            ...
            switch (block->frontage_template) {
                case MDTBFrontageTemplateResidentialCourt:
                    ...
                    continuity_strength_scale = 0.50f;
                    continuity_pull_strength_scale = 0.44f;
                    secondary_strength_scale = 0.38f;
                    secondary_pull_strength_scale = 0.32f;
                    rear_edge_strength_scale = 0.26f;
                    rear_edge_pull_strength_scale = 0.22f;
                    backlot_strength_scale = 0.18f;
                    backlot_pull_strength_scale = 0.14f;
                    infill_strength_scale = 0.10f;
                    infill_pull_strength_scale = 0.08f;
                    inner_enclosure_strength_scale = 0.06f;
                    ...
                    terminal_enclosure_strength_scale = 0.01f;
                    terminal_enclosure_pull_strength_scale = 0.008f;
                    yard_tail_strength_scale = 0.006f;
                    yard_tail_pull_strength_scale = 0.004f;
                    tail_cap_strength_scale = 0.003f;
                    tail_cap_pull_strength_scale = 0.002f;
                    break;
                case MDTBFrontageTemplateTransitMarket:
                    ...
                    continuity_strength_scale = 0.74f;
                    continuity_pull_strength_scale = 0.68f;
                    secondary_strength_scale = 0.62f;
                    secondary_pull_strength_scale = 0.56f;
                    rear_edge_strength_scale = 0.46f;
                    rear_edge_pull_strength_scale = 0.42f;
                    backlot_strength_scale = 0.36f;
                    backlot_pull_strength_scale = 0.32f;
                    infill_strength_scale = 0.26f;
                    infill_pull_strength_scale = 0.22f;
                    inner_enclosure_strength_scale = 0.20f;
                    ...
                    terminal_enclosure_strength_scale = 0.08f;
                    terminal_enclosure_pull_strength_scale = 0.06f;
                    yard_tail_strength_scale = 0.05f;
                    yard_tail_pull_strength_scale = 0.04f;
                    tail_cap_strength_scale = 0.03f;
                    tail_cap_pull_strength_scale = 0.02f;
                    break;
                case MDTBFrontageTemplateServiceSpur:
                    ...
                    continuity_strength_scale = 0.72f;
                    continuity_pull_strength_scale = 0.62f;
                    secondary_strength_scale = 0.58f;
                    secondary_pull_strength_scale = 0.50f;
                    rear_edge_strength_scale = 0.44f;
                    rear_edge_pull_strength_scale = 0.38f;
                    backlot_strength_scale = 0.34f;
                    backlot_pull_strength_scale = 0.30f;
                    infill_strength_scale = 0.24f;
                    infill_pull_strength_scale = 0.20f;
                    inner_enclosure_strength_scale = 0.18f;
                    ...
                    terminal_enclosure_strength_scale = 0.07f;
                    terminal_enclosure_pull_strength_scale = 0.05f;
                    yard_tail_strength_scale = 0.04f;
                    yard_tail_pull_strength_scale = 0.03f;
                    tail_cap_strength_scale = 0.025f;
                    tail_cap_pull_strength_scale = 0.018f;
                    break;
                ...
                default:
                    ...
                    continuity_strength_scale = 0.64f;
                    continuity_pull_strength_scale = 0.58f;
                    secondary_strength_scale = 0.50f;
                    secondary_pull_strength_scale = 0.46f;
                    rear_edge_strength_scale = 0.40f;
                    rear_edge_pull_strength_scale = 0.36f;
                    backlot_strength_scale = 0.30f;
                    backlot_pull_strength_scale = 0.26f;
                    infill_strength_scale = 0.20f;
                    infill_pull_strength_scale = 0.18f;
                    inner_enclosure_strength_scale = 0.16f;
                    ...
                    terminal_enclosure_strength_scale = 0.05f;
                    terminal_enclosure_pull_strength_scale = 0.04f;
                    yard_tail_strength_scale = 0.03f;
                    yard_tail_pull_strength_scale = 0.02f;
                    tail_cap_strength_scale = 0.02f;
                    tail_cap_pull_strength_scale = 0.014f;
                    break;
            }
...

            {
                ...
                const MDTBFloat3 continuity_position =
                    outer_route_continuity_pad_position(block, &route_context);
                const MDTBFloat3 continuity_pull =
                    outer_route_continuity_pull_position(block, &route_context);
                const MDTBFloat3 secondary_position =
                    outer_route_secondary_frontage_position(block, &route_context);
                const MDTBFloat3 secondary_pull =
                    outer_route_secondary_pull_position(block, &route_context);
                const MDTBFloat3 rear_edge_position =
                    outer_route_rear_edge_position(block, &route_context);
                const MDTBFloat3 rear_edge_pull =
                    outer_route_rear_edge_pull_position(block, &route_context);
                const MDTBFloat3 backlot_position =
                    outer_route_backlot_position(block, &route_context);
                const MDTBFloat3 backlot_pull =
                    outer_route_backlot_pull_position(block, &route_context);
                const MDTBFloat3 infill_position =
                    outer_route_infill_position(block, &route_context);
                const MDTBFloat3 infill_pull =
                    outer_route_infill_pull_position(block, &route_context);
                const MDTBFloat3 inner_enclosure_position =
                    outer_route_inner_enclosure_position(block, &route_context);
                const MDTBFloat3 inner_enclosure_pull =
                    outer_route_inner_enclosure_pull_position(block, &route_context);
                const MDTBFloat3 core_backstop_position =
                ...
                const MDTBFloat3 terminal_enclosure_position =
                    outer_route_terminal_enclosure_position(block, &route_context);
                const MDTBFloat3 terminal_enclosure_pull =
                    outer_route_terminal_enclosure_pull_position(block, &route_context);
                const MDTBFloat3 yard_tail_position =
                    outer_route_yard_tail_position(block, &route_context);
                const MDTBFloat3 yard_tail_pull =
                    outer_route_yard_tail_pull_position(block, &route_context);
                const MDTBFloat3 tail_cap_position =
                    outer_route_tail_cap_position(block, &route_context);
                const MDTBFloat3 tail_cap_pull =
                    outer_route_tail_cap_pull_position(block, &route_context);
                ...
                push_traffic_occupancy(
                    continuity_position,
                    fmaxf(route_radius - 0.10f, 1.8f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * continuity_strength_scale
                );
                push_traffic_occupancy(
                    continuity_pull,
                    fmaxf(route_radius - 0.28f, 1.6f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * continuity_pull_strength_scale
                );
                push_traffic_occupancy(
                    secondary_position,
                    fmaxf(route_radius - 0.36f, 1.5f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * secondary_strength_scale
                );
                push_traffic_occupancy(
                    secondary_pull,
                    fmaxf(route_radius - 0.48f, 1.4f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * secondary_pull_strength_scale
                );
                push_traffic_occupancy(
                    rear_edge_position,
                    fmaxf(route_radius - 0.58f, 1.3f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * rear_edge_strength_scale
                );
                push_traffic_occupancy(
                    rear_edge_pull,
                    fmaxf(route_radius - 0.68f, 1.2f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * rear_edge_pull_strength_scale
                );
                push_traffic_occupancy(
                    backlot_position,
                    fmaxf(route_radius - 0.76f, 1.15f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * backlot_strength_scale
                );
                push_traffic_occupancy(
                    backlot_pull,
                    fmaxf(route_radius - 0.84f, 1.1f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * backlot_pull_strength_scale
                );
                push_traffic_occupancy(
                    infill_position,
                    fmaxf(route_radius - 0.92f, 1.05f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * infill_strength_scale
                );
                push_traffic_occupancy(
                    infill_pull,
                    fmaxf(route_radius - 0.98f, 1.0f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * infill_pull_strength_scale
                );
                push_traffic_occupancy(
                    inner_enclosure_position,
                    fmaxf(route_radius - 1.02f, 0.98f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * inner_enclosure_strength_scale
                );
                push_traffic_occupancy(
                    inner_enclosure_pull,
                    fmaxf(route_radius - 1.06f, 0.95f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * inner_enclosure_pull_strength_scale
                );
                push_traffic_occupancy(
                    core_backstop_position,
                    fmaxf(route_radius - 1.10f, 0.92f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * core_backstop_strength_scale
                );
                push_traffic_occupancy(
                    core_backstop_pull,
                    fmaxf(route_radius - 1.14f, 0.90f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                ...
                push_traffic_occupancy(
                    terminal_enclosure_position,
                    fmaxf(route_radius - 1.26f, 0.84f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * terminal_enclosure_strength_scale
                );
                push_traffic_occupancy(
                    terminal_enclosure_pull,
                    fmaxf(route_radius - 1.30f, 0.82f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * terminal_enclosure_pull_strength_scale
                );
                push_traffic_occupancy(
                    yard_tail_position,
                    fmaxf(route_radius - 1.34f, 0.80f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * yard_tail_strength_scale
                );
                push_traffic_occupancy(
                    yard_tail_pull,
                    fmaxf(route_radius - 1.38f, 0.78f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * yard_tail_pull_strength_scale
                );
                push_traffic_occupancy(
                    tail_cap_position,
                    fmaxf(route_radius - 1.42f, 0.76f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * tail_cap_strength_scale
                );
                push_traffic_occupancy(
                    tail_cap_pull,
                    fmaxf(route_radius - 1.46f, 0.74f),
                    (uint32_t)index,
                    route_context.branch_axis,
                    MDTBTrafficOccupancyReasonStopZone,
                    route_strength * tail_cap_pull_strength_scale
                );
            }
...
static MDTBFloat3 oriented_half_extents_for_axis(uint32_t axis, float longitudinal_half, float height_half, float lateral_half) {
    return axis == MDTBRoadAxisEastWest
        ? make_float3(longitudinal_half, height_half, lateral_half)
        : make_float3(lateral_half, height_half, longitudinal_half);
}
...
static MDTBFloat3 offset_outer_route_position(
    ...
    if (route_context->branch_axis == MDTBRoadAxisEastWest) {
        origin.x += longitudinal_offset;
        origin.z += lateral_offset * route_context->route_sign;
    } else {
        origin.x += lateral_offset * route_context->route_sign;
        origin.z += longitudinal_offset;
    }
    return origin;
}

static float outer_route_longitudinal_sign_for_block(const MDTBBlockDescriptor *block) {
    return block != NULL && ((block->variant & 1u) != 0u) ? 1.0f : -1.0f;
}
...
static MDTBFloat3 outer_route_continuity_pad_position(
    ...
    return offset_outer_route_position(
        route_context,
        route_context->marker_position,
        outer_route_longitudinal_sign_for_block(block) * 0.44f,
        3.34f
    );
}
...
static MDTBFloat3 outer_route_continuity_pull_position(
    ...
    return offset_outer_route_position(
        route_context,
        route_context->support_position,
        outer_route_longitudinal_sign_for_block(block) * 1.24f,
        2.18f
    );
}
...
static MDTBFloat3 outer_route_continuity_landmark_position(
    ...
    const MDTBFloat3 continuity_pad = outer_route_continuity_pad_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        continuity_pad,
        outer_route_longitudinal_sign_for_block(block) * 1.18f,
        0.98f
    );
}
...
static MDTBFloat3 outer_route_secondary_frontage_position(
    ...
    const MDTBFloat3 continuity_landmark = outer_route_continuity_landmark_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        continuity_landmark,
        outer_route_longitudinal_sign_for_block(block) * 0.18f,
        1.68f
    );
}
...
static MDTBFloat3 outer_route_secondary_pull_position(
    ...
    return offset_outer_route_position(
        route_context,
        continuity_pad,
        outer_route_longitudinal_sign_for_block(block) * 1.54f,
        1.42f
    );
}
...
static MDTBFloat3 outer_route_secondary_staging_position(
    ...
    const MDTBFloat3 secondary_frontage = outer_route_secondary_frontage_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        secondary_frontage,
        -(outer_route_longitudinal_sign_for_block(block) * 0.42f),
        -0.58f
    );
}
...
static MDTBFloat3 outer_route_rear_edge_position(
    ...
    return offset_outer_route_position(
        route_context,
        secondary_frontage,
        outer_route_longitudinal_sign_for_block(block) * 0.16f,
        1.62f
    );
}
...
static MDTBFloat3 outer_route_rear_edge_pull_position(
    ...
    const MDTBFloat3 secondary_pull = outer_route_secondary_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        secondary_pull,
        outer_route_longitudinal_sign_for_block(block) * 1.02f,
        0.86f
    );
}
...
static MDTBFloat3 outer_route_rear_edge_staging_position(
    ...
    const MDTBFloat3 rear_edge = outer_route_rear_edge_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        rear_edge,
        -(outer_route_longitudinal_sign_for_block(block) * 0.30f),
        -0.46f
    );
}
...
static MDTBFloat3 outer_route_backlot_position(
    ...
    return offset_outer_route_position(
        route_context,
        rear_edge,
        outer_route_longitudinal_sign_for_block(block) * 0.14f,
        1.46f
    );
}
...
static MDTBFloat3 outer_route_backlot_pull_position(
    ...
    const MDTBFloat3 rear_edge_pull = outer_route_rear_edge_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        rear_edge_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.94f,
        0.78f
    );
}
...
static MDTBFloat3 outer_route_backlot_staging_position(
    ...
    const MDTBFloat3 backlot = outer_route_backlot_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        backlot,
        -(outer_route_longitudinal_sign_for_block(block) * 0.26f),
        -0.40f
    );
}
...
static MDTBFloat3 outer_route_infill_position(
    ...
    return offset_outer_route_position(
        route_context,
        backlot,
        outer_route_longitudinal_sign_for_block(block) * 0.10f,
        1.28f
    );
}
...
static MDTBFloat3 outer_route_infill_pull_position(
    ...
    const MDTBFloat3 backlot_pull = outer_route_backlot_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        backlot_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.82f,
        0.68f
    );
}
...
static MDTBFloat3 outer_route_infill_staging_position(
    ...
    const MDTBFloat3 infill = outer_route_infill_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        infill,
        -(outer_route_longitudinal_sign_for_block(block) * 0.22f),
        -0.34f
    );
}
...
static MDTBFloat3 outer_route_inner_enclosure_position(
    ...
    return offset_outer_route_position(
        route_context,
        infill,
        outer_route_longitudinal_sign_for_block(block) * 0.08f,
        1.12f
    );
}
...
static MDTBFloat3 outer_route_inner_enclosure_pull_position(
    ...
    const MDTBFloat3 infill_pull = outer_route_infill_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        infill_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.70f,
        0.60f
    );
}
...
static MDTBFloat3 outer_route_inner_enclosure_staging_position(
    ...
    const MDTBFloat3 inner_enclosure = outer_route_inner_enclosure_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        inner_enclosure,
        -(outer_route_longitudinal_sign_for_block(block) * 0.18f),
...
static MDTBFloat3 outer_route_core_backstop_position(
    ...
    return offset_outer_route_position(
        route_context,
        inner_enclosure,
        outer_route_longitudinal_sign_for_block(block) * 0.06f,
        1.00f
    );
}
...
static MDTBFloat3 outer_route_core_backstop_pull_position(
    ...
    const MDTBFloat3 inner_enclosure_pull = outer_route_inner_enclosure_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        inner_enclosure_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.58f,
        0.50f
    );
}
...
static MDTBFloat3 outer_route_terminal_enclosure_position(
    ...
    return offset_outer_route_position(
        route_context,
        rear_core,
        outer_route_longitudinal_sign_for_block(block) * 0.03f,
        0.76f
    );
}
...
static MDTBFloat3 outer_route_terminal_enclosure_pull_position(
    ...
    const MDTBFloat3 rear_core_pull = outer_route_rear_core_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        rear_core_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.36f,
        0.34f
    );
}
...
static MDTBFloat3 outer_route_terminal_enclosure_staging_position(
    ...
    const MDTBFloat3 terminal_enclosure = outer_route_terminal_enclosure_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        terminal_enclosure,
        -(outer_route_longitudinal_sign_for_block(block) * 0.10f),
...
static MDTBFloat3 outer_route_yard_tail_position(
    ...
    return offset_outer_route_position(
        route_context,
        terminal_enclosure,
        outer_route_longitudinal_sign_for_block(block) * 0.02f,
        0.66f
    );
}
...
static MDTBFloat3 outer_route_yard_tail_pull_position(
    ...
    const MDTBFloat3 terminal_enclosure_pull = outer_route_terminal_enclosure_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        terminal_enclosure_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.28f,
        0.28f
    );
}
...
static MDTBFloat3 outer_route_yard_tail_staging_position(
    ...
    const MDTBFloat3 yard_tail = outer_route_yard_tail_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        yard_tail,
        -(outer_route_longitudinal_sign_for_block(block) * 0.08f),
...
static MDTBFloat3 outer_route_tail_cap_pull_position(
    ...
    const MDTBFloat3 yard_tail_pull = outer_route_yard_tail_pull_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        yard_tail_pull,
        outer_route_longitudinal_sign_for_block(block) * 0.22f,
...
static MDTBFloat3 outer_route_tail_cap_staging_position(
    ...
    const MDTBFloat3 tail_cap = outer_route_tail_cap_position(block, route_context);
    return offset_outer_route_position(
        route_context,
        tail_cap,
        -(outer_route_longitudinal_sign_for_block(block) * 0.06f),
...
static void build_outer_route_frontage_massing(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    ...
    const float axis_x = route_context->branch_axis == MDTBRoadAxisEastWest ? 1.0f : 0.0f;
    const float axis_z = route_context->branch_axis == MDTBRoadAxisEastWest ? 0.0f : 1.0f;
    const float cross_x = route_context->branch_axis == MDTBRoadAxisEastWest ? 0.0f : route_context->route_sign;
    const float cross_z = route_context->branch_axis == MDTBRoadAxisEastWest ? route_context->route_sign : 0.0f;
    MDTBFloat3 apron_center = make_float3(
        ((route_context->pad_position.x + route_context->support_position.x) * 0.5f) + (cross_x * 0.24f),
        kSidewalkHeight + 0.015f,
        ((route_context->pad_position.z + route_context->support_position.z) * 0.5f) + (cross_z * 0.24f)
    );
    MDTBFloat3 mass_center = make_float3(
        ((route_context->support_position.x + route_context->marker_position.x) * 0.5f),
        kSidewalkHeight,
        ((route_context->support_position.z + route_context->marker_position.z) * 0.5f)
    );
    MDTBFloat4 apron_color = make_float4(0.44f, 0.42f, 0.38f, 1.0f);
    MDTBFloat4 curb_color = make_float4(0.66f, 0.63f, 0.58f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.54f, 0.50f, 0.44f, 1.0f);
    MDTBFloat4 roof_color = make_float4(0.30f, 0.32f, 0.35f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.34f, 0.33f, 0.31f, 1.0f);
    float apron_axis_half = 2.6f;
    float apron_cross_half = 1.4f;
    float curb_shift = 0.0f;
    float mass_axis_half = 2.0f;
    float mass_cross_half = 0.18f;
    float mass_half_height = 0.88f;
    float mass_shift = 1.38f;
    float roof_axis_half = 2.2f;
    float roof_cross_half = 0.86f;
    float roof_height = 2.10f;
    float roof_shift = 0.72f;
    float post_axis_offset = 1.66f;
    float post_cross_shift = 0.26f;
    int add_posts = 1;

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            apron_color = make_float4(0.36f, 0.36f, 0.37f, 1.0f);
            curb_color = make_float4(0.70f, 0.68f, 0.62f, 1.0f);
            mass_color = make_float4(0.58f, 0.55f, 0.49f, 1.0f);
            roof_color = make_float4(0.41f, 0.39f, 0.34f, 1.0f);
            post_color = make_float4(0.48f, 0.42f, 0.35f, 1.0f);
            apron_axis_half = 2.7f;
            apron_cross_half = 1.55f;
            mass_axis_half = 2.2f;
            mass_cross_half = 0.10f;
            mass_half_height = 0.54f;
            mass_shift = 1.72f;
            roof_axis_half = 2.0f;
            roof_cross_half = 1.04f;
            roof_height = 2.06f;
            roof_shift = 0.96f;
            post_axis_offset = 1.44f;
            post_cross_shift = 0.10f;
            break;
        case MDTBFrontageTemplateTransitMarket:
            apron_color = make_float4(0.52f, 0.50f, 0.46f, 1.0f);
            curb_color = make_float4(0.72f, 0.70f, 0.66f, 1.0f);
            mass_color = make_float4(0.58f, 0.61f, 0.66f, 1.0f);
            roof_color = make_float4(0.25f, 0.42f, 0.58f, 1.0f);
            post_color = make_float4(0.28f, 0.31f, 0.35f, 1.0f);
            apron_axis_half = 3.0f;
            apron_cross_half = 1.72f;
            curb_shift = 0.08f;
            mass_axis_half = 2.6f;
            mass_cross_half = 0.18f;
            mass_half_height = 1.02f;
            mass_shift = 1.52f;
            roof_axis_half = 2.7f;
            roof_cross_half = 1.10f;
            roof_height = 2.30f;
            roof_shift = 0.70f;
            post_axis_offset = 2.02f;
            post_cross_shift = 0.18f;
            break;
        case MDTBFrontageTemplateServiceSpur:
            apron_color = make_float4(0.29f, 0.29f, 0.30f, 1.0f);
            curb_color = make_float4(0.63f, 0.60f, 0.56f, 1.0f);
            mass_color = make_float4(0.46f, 0.42f, 0.38f, 1.0f);
            roof_color = make_float4(0.34f, 0.32f, 0.28f, 1.0f);
            post_color = make_float4(0.30f, 0.29f, 0.27f, 1.0f);
            apron_axis_half = 3.4f;
            apron_cross_half = 1.84f;
            curb_shift = -0.04f;
            mass_axis_half = 2.9f;
            mass_cross_half = 0.14f;
            mass_half_height = 1.16f;
            mass_shift = 1.82f;
            roof_axis_half = 2.8f;
            roof_cross_half = 1.00f;
            roof_height = 2.34f;
            roof_shift = 0.94f;
            post_axis_offset = 2.12f;
            post_cross_shift = 0.26f;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            apron_color = make_float4(0.48f, 0.44f, 0.40f, 1.0f);
            curb_color = make_float4(0.70f, 0.66f, 0.60f, 1.0f);
            mass_color = make_float4(0.61f, 0.53f, 0.46f, 1.0f);
            roof_color = make_float4(0.48f, 0.28f, 0.22f, 1.0f);
            post_color = make_float4(0.35f, 0.29f, 0.26f, 1.0f);
            apron_axis_half = 2.9f;
            apron_cross_half = 1.62f;
            curb_shift = 0.04f;
            mass_axis_half = 1.28f;
            mass_cross_half = 0.34f;
            mass_half_height = 1.06f;
            mass_shift = 1.30f;
            roof_axis_half = 2.3f;
            roof_cross_half = 0.92f;
            roof_height = 2.18f;
            roof_shift = 0.66f;
            post_axis_offset = 1.52f;
            post_cross_shift = 0.14f;
            break;
    }

    mass_center.x += cross_x * mass_shift;
    mass_center.y = kSidewalkHeight + mass_half_height;
    mass_center.z += cross_z * mass_shift;

    push_scene_box(make_box(
        apron_center,
        oriented_half_extents_for_axis(route_context->branch_axis, apron_axis_half, 0.015f, apron_cross_half),
        apron_color
    ));
    push_scene_box(make_box(
        make_float3(
            apron_center.x - (cross_x * (apron_cross_half - 0.14f + curb_shift)),
            kSidewalkHeight + 0.04f,
            apron_center.z - (cross_z * (apron_cross_half - 0.14f + curb_shift))
        ),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(apron_axis_half - 0.32f, 1.2f), 0.015f, 0.08f),
        curb_color
    ));
    push_scene_box(make_box(
        make_float3(apron_center.x + (cross_x * 0.16f), kSidewalkHeight + 0.02f, apron_center.z + (cross_z * 0.16f)),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(apron_axis_half - 0.56f, 1.0f), 0.01f, 0.06f),
        scaled_color(apron_color, 0.84f)
    ));
    push_prop(
        mass_center,
    ...
    push_prop(
        make_float3(
            mass_center.x - (cross_x * (mass_shift - roof_shift)),
            kSidewalkHeight + roof_height,
            mass_center.z - (cross_z * (mass_shift - roof_shift))
        ),
        oriented_half_extents_for_axis(route_context->branch_axis, roof_axis_half, 0.08f, roof_cross_half),
        roof_color,
        0
    );

    if (add_posts) {
        for (int post_sign = -1; post_sign <= 1; post_sign += 2) {
            push_prop(
                make_float3(
                    mass_center.x + (((float)post_sign) * axis_x * post_axis_offset) - (cross_x * post_cross_shift),
                    kSidewalkHeight + (roof_height * 0.5f),
                    mass_center.z + (((float)post_sign) * axis_z * post_axis_offset) - (cross_z * post_cross_shift)
                ),
                oriented_half_extents_for_axis(route_context->branch_axis, 0.05f, roof_height * 0.5f, 0.05f),
                post_color,
                1
            );
        }
...
static void build_outer_route_edge_continuity(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 continuity_center;
    MDTBFloat3 curb_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 landmark_center;
    MDTBFloat4 continuity_color = make_float4(0.43f, 0.41f, 0.37f, 1.0f);
    MDTBFloat4 curb_color = make_float4(0.69f, 0.66f, 0.60f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.31f, 0.29f, 0.27f, 1.0f);
    MDTBFloat4 landmark_color = make_float4(0.55f, 0.49f, 0.43f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.34f, 0.35f, 0.38f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float continuity_axis_half = 2.3f;
    float continuity_cross_half = 1.14f;
    float curb_axis_half = 1.86f;
    float curb_height = 0.20f;
    float landmark_axis_half = 0.54f;
    float landmark_half_height = 1.04f;
    float landmark_cross_half = 0.32f;
    float cap_axis_half = 0.86f;
    float cap_height = 2.24f;
    float cap_cross_half = 0.42f;
    float post_axis_offset = 0.74f;
    float post_cross_shift = 0.20f;
    int add_posts = 1;
    int add_planters = 0;
    int add_bollards = 0;
    ...
    continuity_center = outer_route_continuity_pad_position(block, route_context);
    curb_center = offset_outer_route_position(route_context, continuity_center, -along_sign * 0.16f, 0.94f);
    seam_center = offset_outer_route_position(route_context, continuity_center, 0.0f, -0.24f);
    landmark_center = outer_route_continuity_landmark_position(block, route_context);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            continuity_color = make_float4(0.49f, 0.47f, 0.43f, 1.0f);
            curb_color = make_float4(0.75f, 0.72f, 0.67f, 1.0f);
            seam_color = make_float4(0.37f, 0.35f, 0.33f, 1.0f);
            landmark_color = make_float4(0.58f, 0.54f, 0.49f, 1.0f);
            cap_color = make_float4(0.43f, 0.40f, 0.35f, 1.0f);
            continuity_axis_half = 2.1f;
            continuity_cross_half = 1.18f;
            curb_axis_half = 1.70f;
            curb_height = 0.18f;
            landmark_axis_half = 0.68f;
            landmark_half_height = 0.84f;
            landmark_cross_half = 0.12f;
            cap_axis_half = 1.20f;
            cap_height = 2.06f;
            cap_cross_half = 0.58f;
            post_axis_offset = 0.96f;
            post_cross_shift = 0.28f;
            add_planters = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            continuity_color = make_float4(0.54f, 0.52f, 0.48f, 1.0f);
            curb_color = make_float4(0.73f, 0.71f, 0.68f, 1.0f);
            seam_color = make_float4(0.34f, 0.35f, 0.37f, 1.0f);
            landmark_color = make_float4(0.30f, 0.50f, 0.63f, 1.0f);
            cap_color = make_float4(0.24f, 0.42f, 0.58f, 1.0f);
            continuity_axis_half = 2.6f;
            continuity_cross_half = 1.26f;
            curb_axis_half = 2.10f;
            curb_height = 0.22f;
            landmark_axis_half = 0.32f;
            landmark_half_height = 1.20f;
            landmark_cross_half = 0.54f;
            cap_axis_half = 1.08f;
            cap_height = 2.32f;
            cap_cross_half = 0.62f;
            post_axis_offset = 0.88f;
            post_cross_shift = 0.22f;
            break;
        case MDTBFrontageTemplateServiceSpur:
            continuity_color = make_float4(0.31f, 0.31f, 0.32f, 1.0f);
            curb_color = make_float4(0.59f, 0.57f, 0.53f, 1.0f);
            seam_color = make_float4(0.23f, 0.23f, 0.24f, 1.0f);
            landmark_color = make_float4(0.44f, 0.41f, 0.37f, 1.0f);
            cap_color = make_float4(0.34f, 0.32f, 0.28f, 1.0f);
            continuity_axis_half = 2.9f;
            continuity_cross_half = 1.34f;
            curb_axis_half = 2.40f;
            curb_height = 0.26f;
            landmark_axis_half = 1.26f;
            landmark_half_height = 1.18f;
            landmark_cross_half = 0.18f;
            cap_axis_half = 1.34f;
            cap_height = 2.30f;
            cap_cross_half = 0.36f;
            post_axis_offset = 1.02f;
            post_cross_shift = 0.12f;
            add_posts = 0;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            continuity_color = make_float4(0.47f, 0.44f, 0.40f, 1.0f);
            curb_color = make_float4(0.70f, 0.66f, 0.61f, 1.0f);
            seam_color = make_float4(0.32f, 0.29f, 0.26f, 1.0f);
            landmark_color = make_float4(0.60f, 0.49f, 0.42f, 1.0f);
            cap_color = make_float4(0.48f, 0.30f, 0.23f, 1.0f);
            continuity_axis_half = 2.4f;
            continuity_cross_half = 1.18f;
            curb_axis_half = 1.96f;
            curb_height = 0.20f;
            landmark_axis_half = 0.54f;
            landmark_half_height = 1.16f;
            landmark_cross_half = 0.42f;
            cap_axis_half = 0.92f;
            cap_height = 2.24f;
            cap_cross_half = 0.48f;
            post_axis_offset = 0.72f;
            post_cross_shift = 0.18f;
            add_planters = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(continuity_center.x, kRoadHeight + 0.015f, continuity_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, continuity_axis_half, 0.015f, continuity_cross_half),
        continuity_color
    ));
    push_scene_box(make_box(
        make_float3(curb_center.x, kRoadHeight + curb_height, curb_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, curb_axis_half, curb_height, 0.08f),
        curb_color
    ));
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(continuity_axis_half - 0.34f, 1.2f), 0.01f, 0.06f),
        seam_color
    ));

    landmark_center.y = kRoadHeight + landmark_half_height;
    push_prop(
        landmark_center,
        oriented_half_extents_for_axis(route_context->branch_axis, landmark_axis_half, landmark_half_height, landmark_cross_half),
        landmark_color,
        1
    );

    {
        MDTBFloat3 cap_center = offset_outer_route_position(route_context, landmark_center, -along_sign * 0.08f, -0.18f);
        cap_center.y = kRoadHeight + cap_height;
        push_prop(
            cap_center,
            oriented_half_extents_for_axis(route_context->branch_axis, cap_axis_half, 0.08f, cap_cross_half),
            cap_color,
            0
        );
    }
    ...
    if (add_posts) {
        MDTBFloat3 left_post = offset_outer_route_position(route_context, landmark_center, -along_sign * post_axis_offset, post_cross_shift);
        MDTBFloat3 right_post = offset_outer_route_position(route_context, landmark_center, along_sign * post_axis_offset, post_cross_shift);
        left_post.y = kRoadHeight + 0.92f;
        right_post.y = kRoadHeight + 0.92f;
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.08f, 0.92f, 0.08f),
            scaled_color(landmark_color, 0.88f),
            1
        );
        push_prop(
            right_post,
    ...
    if (add_planters) {
        MDTBFloat3 left_planter = offset_outer_route_position(route_context, continuity_center, -along_sign * 1.04f, -0.12f);
        MDTBFloat3 right_planter = offset_outer_route_position(route_context, continuity_center, along_sign * 1.04f, -0.12f);
        push_planter(left_planter.x, left_planter.z, 0.32f);
        push_planter(right_planter.x, right_planter.z, 0.30f);
    }

    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, continuity_center, -along_sign * 1.18f, -0.18f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, continuity_center, along_sign * 1.18f, -0.18f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_secondary_frontage(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 roof_center;
    MDTBFloat4 pad_color = make_float4(0.42f, 0.40f, 0.37f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.30f, 0.29f, 0.27f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.54f, 0.49f, 0.44f, 1.0f);
    MDTBFloat4 roof_color = make_float4(0.33f, 0.34f, 0.37f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.35f, 0.34f, 0.32f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.96f;
    float pad_cross_half = 0.96f;
    float mass_axis_half = 1.32f;
    float mass_half_height = 0.72f;
    float mass_cross_half = 0.22f;
    float roof_axis_half = 1.72f;
    float roof_height = 1.92f;
    float roof_cross_half = 0.74f;
    float post_axis_offset = 1.02f;
    float post_cross_shift = 0.16f;
    int add_posts = 1;
    int add_planters = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_secondary_frontage_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.28f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.12f, 0.30f);
    roof_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.10f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.48f, 0.46f, 0.42f, 1.0f);
            seam_color = make_float4(0.37f, 0.35f, 0.33f, 1.0f);
            mass_color = make_float4(0.57f, 0.53f, 0.48f, 1.0f);
            roof_color = make_float4(0.41f, 0.39f, 0.35f, 1.0f);
            post_color = make_float4(0.48f, 0.43f, 0.36f, 1.0f);
            pad_axis_half = 2.10f;
            pad_cross_half = 1.02f;
            mass_axis_half = 1.58f;
            mass_half_height = 0.42f;
            mass_cross_half = 0.10f;
            roof_axis_half = 2.04f;
            roof_height = 1.94f;
            roof_cross_half = 0.86f;
            post_axis_offset = 1.18f;
            post_cross_shift = 0.22f;
            add_planters = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.54f, 0.52f, 0.48f, 1.0f);
            seam_color = make_float4(0.33f, 0.34f, 0.36f, 1.0f);
            mass_color = make_float4(0.33f, 0.52f, 0.64f, 1.0f);
            roof_color = make_float4(0.24f, 0.42f, 0.58f, 1.0f);
            post_color = make_float4(0.29f, 0.32f, 0.36f, 1.0f);
            pad_axis_half = 2.22f;
            pad_cross_half = 1.08f;
            mass_axis_half = 0.24f;
            mass_half_height = 1.10f;
            mass_cross_half = 0.62f;
            roof_axis_half = 1.86f;
            roof_height = 2.12f;
            roof_cross_half = 0.92f;
            post_axis_offset = 0.98f;
            post_cross_shift = 0.20f;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.31f, 0.31f, 0.32f, 1.0f);
            seam_color = make_float4(0.23f, 0.23f, 0.24f, 1.0f);
            mass_color = make_float4(0.45f, 0.42f, 0.38f, 1.0f);
            roof_color = make_float4(0.34f, 0.32f, 0.29f, 1.0f);
            post_color = make_float4(0.30f, 0.29f, 0.27f, 1.0f);
            pad_axis_half = 2.46f;
            pad_cross_half = 1.14f;
            mass_axis_half = 1.90f;
            mass_half_height = 0.84f;
            mass_cross_half = 0.12f;
            roof_axis_half = 2.10f;
            roof_height = 1.98f;
            roof_cross_half = 0.48f;
            post_axis_offset = 1.12f;
            post_cross_shift = 0.12f;
            add_posts = 0;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.47f, 0.44f, 0.40f, 1.0f);
            seam_color = make_float4(0.32f, 0.29f, 0.26f, 1.0f);
            mass_color = make_float4(0.60f, 0.50f, 0.43f, 1.0f);
            roof_color = make_float4(0.48f, 0.30f, 0.22f, 1.0f);
            post_color = make_float4(0.35f, 0.29f, 0.26f, 1.0f);
            pad_axis_half = 2.06f;
            pad_cross_half = 1.00f;
            mass_axis_half = 1.18f;
            mass_half_height = 0.94f;
            mass_cross_half = 0.32f;
            roof_axis_half = 1.46f;
            roof_height = 2.02f;
            roof_cross_half = 0.58f;
            post_axis_offset = 0.82f;
            post_cross_shift = 0.16f;
            add_planters = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.26f, 1.2f), 0.01f, 0.06f),
        seam_color
    ));
    ...
    roof_center.y = kRoadHeight + roof_height;
    push_prop(
        roof_center,
        oriented_half_extents_for_axis(route_context->branch_axis, roof_axis_half, 0.08f, roof_cross_half),
        roof_color,
    ...
    if (add_posts) {
        MDTBFloat3 left_post = offset_outer_route_position(route_context, roof_center, -along_sign * post_axis_offset, post_cross_shift);
        MDTBFloat3 right_post = offset_outer_route_position(route_context, roof_center, along_sign * post_axis_offset, post_cross_shift);
        left_post.y = kRoadHeight + 0.86f;
        right_post.y = kRoadHeight + 0.86f;
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.07f, 0.86f, 0.07f),
            post_color,
            1
        );
        push_prop(
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 1.04f, -0.12f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 1.04f, -0.12f).z,
                0.28f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 1.04f, -0.12f).x,
            ...
            push_tree(
                offset_outer_route_position(route_context, roof_center, along_sign * 1.36f, 0.82f).x,
                offset_outer_route_position(route_context, roof_center, along_sign * 1.36f, 0.82f).z,
                0.76f
            );
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 rear_panel = offset_outer_route_position(route_context, mass_center, 0.0f, 0.18f);
                MDTBFloat3 bench_base = offset_outer_route_position(route_context, pad_center, -along_sign * 1.02f, -0.04f);
                rear_panel.y = kRoadHeight + 1.08f;
                bench_base.y = kRoadHeight + 0.18f;
                push_prop(
                    rear_panel,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.10f, 1.08f, 0.52f),
                    scaled_color(mass_color, 0.88f),
                    1
                );
                push_prop(
                    bench_base,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.48f, 0.18f, 0.16f),
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 service_screen = offset_outer_route_position(route_context, mass_center, 0.0f, 0.18f);
                MDTBFloat3 cargo_block = offset_outer_route_position(route_context, pad_center, along_sign * 1.10f, -0.02f);
                service_screen.y = kRoadHeight + 0.92f;
                cargo_block.y = kRoadHeight + 0.26f;
                push_prop(
                    service_screen,
                    oriented_half_extents_for_axis(route_context->branch_axis, 1.78f, 0.92f, 0.08f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    cargo_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.34f, 0.26f, 0.28f),
                    make_float4(0.36f, 0.34f, 0.31f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 stoop = offset_outer_route_position(route_context, pad_center, 0.0f, -0.08f);
                stoop.y = kRoadHeight + 0.18f;
                push_prop(
                    stoop,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.96f, 0.18f, 0.08f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.92f, -0.14f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.92f, -0.14f).z,
                0.28f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.92f, -0.14f).x,
    ...
    if (add_planters) {
        MDTBFloat3 left_planter = offset_outer_route_position(route_context, pad_center, -along_sign * 1.22f, 0.28f);
        MDTBFloat3 right_planter = offset_outer_route_position(route_context, pad_center, along_sign * 1.22f, 0.28f);
        push_planter(left_planter.x, left_planter.z, 0.26f);
        push_planter(right_planter.x, right_planter.z, 0.24f);
    }

    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 1.24f, -0.16f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 1.24f, -0.16f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_rear_edge_structure(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 wall_center;
    MDTBFloat4 pad_color = make_float4(0.40f, 0.38f, 0.35f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.29f, 0.28f, 0.26f, 1.0f);
    MDTBFloat4 wall_color = make_float4(0.52f, 0.47f, 0.42f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.34f, 0.35f, 0.37f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.72f;
    float pad_cross_half = 0.88f;
    float wall_axis_half = 1.42f;
    float wall_half_height = 0.84f;
    float wall_cross_half = 0.12f;
    float cap_axis_half = 1.20f;
    float cap_cross_half = 0.34f;
    float cap_height = 1.76f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_rear_edge_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.24f);
    wall_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.10f, 0.20f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.47f, 0.45f, 0.41f, 1.0f);
            seam_color = make_float4(0.36f, 0.34f, 0.32f, 1.0f);
            wall_color = make_float4(0.58f, 0.54f, 0.49f, 1.0f);
            cap_color = make_float4(0.43f, 0.40f, 0.35f, 1.0f);
            pad_axis_half = 1.88f;
            pad_cross_half = 0.92f;
            wall_axis_half = 1.68f;
            wall_half_height = 0.32f;
            wall_cross_half = 0.08f;
            cap_axis_half = 1.54f;
            cap_cross_half = 0.48f;
            cap_height = 1.84f;
            add_posts = 1;
            ...
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.52f, 0.50f, 0.47f, 1.0f);
            seam_color = make_float4(0.33f, 0.34f, 0.36f, 1.0f);
            wall_color = make_float4(0.31f, 0.50f, 0.62f, 1.0f);
            cap_color = make_float4(0.24f, 0.42f, 0.58f, 1.0f);
            pad_axis_half = 1.96f;
            pad_cross_half = 0.96f;
            wall_axis_half = 0.12f;
            wall_half_height = 1.10f;
            wall_cross_half = 0.58f;
            cap_axis_half = 1.14f;
            cap_cross_half = 0.52f;
            cap_height = 2.04f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.30f, 0.30f, 0.31f, 1.0f);
            seam_color = make_float4(0.23f, 0.23f, 0.24f, 1.0f);
            wall_color = make_float4(0.44f, 0.41f, 0.37f, 1.0f);
            cap_color = make_float4(0.34f, 0.32f, 0.28f, 1.0f);
            pad_axis_half = 2.14f;
            pad_cross_half = 1.00f;
            wall_axis_half = 1.84f;
            wall_half_height = 0.96f;
            wall_cross_half = 0.10f;
            cap_axis_half = 1.52f;
            cap_cross_half = 0.18f;
            cap_height = 1.86f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.46f, 0.43f, 0.39f, 1.0f);
            seam_color = make_float4(0.31f, 0.29f, 0.26f, 1.0f);
            wall_color = make_float4(0.59f, 0.49f, 0.42f, 1.0f);
            cap_color = make_float4(0.48f, 0.30f, 0.23f, 1.0f);
            pad_axis_half = 1.82f;
            pad_cross_half = 0.90f;
            wall_axis_half = 1.28f;
            wall_half_height = 0.96f;
            wall_cross_half = 0.26f;
            cap_axis_half = 1.04f;
            cap_cross_half = 0.34f;
            cap_height = 1.92f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.22f, 1.2f), 0.01f, 0.06f),
        seam_color
    ));

    wall_center.y = kRoadHeight + wall_half_height;
    push_prop(
        wall_center,
        oriented_half_extents_for_axis(route_context->branch_axis, wall_axis_half, wall_half_height, wall_cross_half),
        wall_color,
        1
    );

    {
        MDTBFloat3 cap_center = offset_outer_route_position(route_context, wall_center, 0.0f, -0.10f);
        cap_center.y = kRoadHeight + cap_height;
        push_prop(
            cap_center,
            oriented_half_extents_for_axis(route_context->branch_axis, cap_axis_half, 0.08f, cap_cross_half),
    ...
    if (add_posts) {
        MDTBFloat3 left_post = offset_outer_route_position(route_context, wall_center, -along_sign * (wall_axis_half - 0.24f), 0.10f);
        MDTBFloat3 right_post = offset_outer_route_position(route_context, wall_center, along_sign * (wall_axis_half - 0.24f), 0.10f);
        left_post.y = kRoadHeight + 0.82f;
        right_post.y = kRoadHeight + 0.82f;
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.06f, 0.82f, 0.06f),
            scaled_color(wall_color, 0.86f),
            1
        );
        push_prop(
            right_post,
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.92f, -0.12f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.92f, -0.12f).z,
                0.24f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.92f, -0.12f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 1.12f, 0.72f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 1.12f, 0.72f).z,
                    0.70f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 ad_panel = offset_outer_route_position(route_context, wall_center, 0.0f, -0.10f);
                ad_panel.y = kRoadHeight + 0.82f;
                push_prop(
                    ad_panel,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.10f, 0.82f, 0.40f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 utility_block = offset_outer_route_position(route_context, pad_center, along_sign * 1.04f, -0.06f);
                utility_block.y = kRoadHeight + 0.30f;
                push_prop(
                    utility_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.42f, 0.30f, 0.26f),
                    make_float4(0.36f, 0.34f, 0.31f, 1.0f),
                    1
                );
            }
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.08f);
                plinth.y = kRoadHeight + 0.18f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.88f, 0.18f, 0.08f),
                    scaled_color(wall_color, 0.90f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.82f, -0.12f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.82f, -0.12f).z,
                0.22f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.82f, -0.12f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 1.02f, -0.12f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 1.02f, -0.12f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_backlot_coverage(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 span_center;
    MDTBFloat3 roof_center;
    MDTBFloat4 pad_color = make_float4(0.38f, 0.36f, 0.34f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.28f, 0.27f, 0.25f, 1.0f);
    MDTBFloat4 span_color = make_float4(0.50f, 0.45f, 0.40f, 1.0f);
    MDTBFloat4 roof_color = make_float4(0.32f, 0.33f, 0.35f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.34f, 0.33f, 0.31f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.58f;
    float pad_cross_half = 0.82f;
    float span_axis_half = 1.26f;
    float span_half_height = 0.96f;
    float span_cross_half = 0.16f;
    float roof_axis_half = 1.10f;
    float roof_height = 2.04f;
    float roof_cross_half = 0.36f;
    float post_axis_offset = 0.84f;
    float post_cross_shift = 0.10f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_backlot_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.22f);
    span_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.08f, 0.18f);
    roof_center = offset_outer_route_position(route_context, span_center, 0.0f, -0.06f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.46f, 0.44f, 0.40f, 1.0f);
            seam_color = make_float4(0.35f, 0.33f, 0.31f, 1.0f);
            span_color = make_float4(0.57f, 0.53f, 0.48f, 1.0f);
            roof_color = make_float4(0.42f, 0.39f, 0.34f, 1.0f);
            post_color = make_float4(0.47f, 0.42f, 0.36f, 1.0f);
            pad_axis_half = 1.72f;
            pad_cross_half = 0.86f;
            span_axis_half = 1.58f;
            span_half_height = 0.52f;
            span_cross_half = 0.10f;
            roof_axis_half = 1.74f;
            roof_height = 1.98f;
            roof_cross_half = 0.54f;
            post_axis_offset = 0.96f;
            post_cross_shift = 0.18f;
            add_posts = 1;
            add_tree = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.50f, 0.49f, 0.45f, 1.0f);
            seam_color = make_float4(0.32f, 0.33f, 0.35f, 1.0f);
            span_color = make_float4(0.30f, 0.49f, 0.61f, 1.0f);
            roof_color = make_float4(0.24f, 0.42f, 0.58f, 1.0f);
            post_color = make_float4(0.29f, 0.32f, 0.36f, 1.0f);
            pad_axis_half = 1.82f;
            pad_cross_half = 0.90f;
            span_axis_half = 0.16f;
            span_half_height = 1.22f;
            span_cross_half = 0.66f;
            roof_axis_half = 1.22f;
            roof_height = 2.22f;
            roof_cross_half = 0.58f;
            post_axis_offset = 0.72f;
            post_cross_shift = 0.16f;
            ...
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.29f, 0.29f, 0.30f, 1.0f);
            seam_color = make_float4(0.22f, 0.22f, 0.23f, 1.0f);
            span_color = make_float4(0.42f, 0.39f, 0.35f, 1.0f);
            roof_color = make_float4(0.33f, 0.31f, 0.28f, 1.0f);
            post_color = make_float4(0.30f, 0.29f, 0.27f, 1.0f);
            pad_axis_half = 2.02f;
            pad_cross_half = 0.94f;
            span_axis_half = 1.98f;
            span_half_height = 1.04f;
            span_cross_half = 0.12f;
            roof_axis_half = 1.68f;
            roof_height = 2.00f;
            roof_cross_half = 0.24f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.45f, 0.42f, 0.38f, 1.0f);
            seam_color = make_float4(0.30f, 0.28f, 0.25f, 1.0f);
            span_color = make_float4(0.58f, 0.48f, 0.41f, 1.0f);
            roof_color = make_float4(0.47f, 0.29f, 0.22f, 1.0f);
            post_color = make_float4(0.35f, 0.29f, 0.26f, 1.0f);
            pad_axis_half = 1.66f;
            pad_cross_half = 0.84f;
            span_axis_half = 1.14f;
            span_half_height = 1.00f;
            span_cross_half = 0.28f;
            roof_axis_half = 1.02f;
            roof_height = 2.08f;
            roof_cross_half = 0.40f;
            post_axis_offset = 0.70f;
            post_cross_shift = 0.14f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.18f, 1.1f), 0.01f, 0.06f),
        seam_color
    ));

    span_center.y = kRoadHeight + span_half_height;
    push_prop(
        span_center,
        oriented_half_extents_for_axis(route_context->branch_axis, span_axis_half, span_half_height, span_cross_half),
        span_color,
        1
    );
    ...
    if (add_posts) {
        MDTBFloat3 left_post = offset_outer_route_position(route_context, roof_center, -along_sign * post_axis_offset, post_cross_shift);
        MDTBFloat3 right_post = offset_outer_route_position(route_context, roof_center, along_sign * post_axis_offset, post_cross_shift);
        left_post.y = kRoadHeight + (roof_height * 0.5f);
        right_post.y = kRoadHeight + (roof_height * 0.5f);
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.06f, roof_height * 0.5f, 0.06f),
            post_color,
            1
        );
        push_prop(
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.78f, -0.10f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.78f, -0.10f).z,
                0.20f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.78f, -0.10f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.94f, 0.76f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.94f, 0.76f).z,
                    0.66f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 sign_box = offset_outer_route_position(route_context, span_center, 0.0f, -0.10f);
                MDTBFloat3 queue_rail = offset_outer_route_position(route_context, pad_center, -along_sign * 0.78f, -0.06f);
                sign_box.y = kRoadHeight + 0.76f;
                queue_rail.y = kRoadHeight + 0.16f;
                push_prop(
                    sign_box,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.16f, 0.76f, 0.36f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    queue_rail,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.38f, 0.16f, 0.12f),
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 shed_screen = offset_outer_route_position(route_context, span_center, 0.0f, 0.20f);
                MDTBFloat3 crate = offset_outer_route_position(route_context, pad_center, along_sign * 0.92f, -0.04f);
                shed_screen.y = kRoadHeight + 0.52f;
                crate.y = kRoadHeight + 0.28f;
                push_prop(
                    shed_screen,
                    oriented_half_extents_for_axis(route_context->branch_axis, 1.76f, 0.52f, 0.08f),
                    scaled_color(span_color, 0.84f),
                    1
                );
                push_prop(
                    crate,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.34f, 0.28f, 0.24f),
                    make_float4(0.35f, 0.33f, 0.30f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.06f);
                plinth.y = kRoadHeight + 0.16f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.80f, 0.16f, 0.08f),
                    scaled_color(span_color, 0.90f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.72f, -0.10f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.72f, -0.10f).z,
                0.18f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.72f, -0.10f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.94f, -0.10f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.94f, -0.10f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_infill_massing(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 roof_center;
    MDTBFloat4 pad_color = make_float4(0.36f, 0.35f, 0.33f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.27f, 0.26f, 0.24f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.48f, 0.44f, 0.40f, 1.0f);
    MDTBFloat4 roof_color = make_float4(0.31f, 0.32f, 0.34f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.33f, 0.32f, 0.30f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.38f;
    float pad_cross_half = 0.72f;
    float mass_axis_half = 1.08f;
    float mass_half_height = 0.92f;
    float mass_cross_half = 0.14f;
    float roof_axis_half = 0.96f;
    float roof_height = 1.98f;
    float roof_cross_half = 0.30f;
    float post_axis_offset = 0.68f;
    float post_cross_shift = 0.08f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_infill_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.18f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.06f, 0.14f);
    roof_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.04f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.44f, 0.42f, 0.38f, 1.0f);
            seam_color = make_float4(0.34f, 0.32f, 0.30f, 1.0f);
            mass_color = make_float4(0.56f, 0.52f, 0.47f, 1.0f);
            roof_color = make_float4(0.41f, 0.38f, 0.34f, 1.0f);
            post_color = make_float4(0.46f, 0.41f, 0.36f, 1.0f);
            pad_axis_half = 1.52f;
            pad_cross_half = 0.76f;
            mass_axis_half = 1.34f;
            mass_half_height = 0.44f;
            mass_cross_half = 0.10f;
            roof_axis_half = 1.44f;
            roof_height = 1.88f;
            roof_cross_half = 0.44f;
            post_axis_offset = 0.86f;
            post_cross_shift = 0.12f;
            add_posts = 1;
            add_tree = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.48f, 0.47f, 0.43f, 1.0f);
            seam_color = make_float4(0.31f, 0.32f, 0.34f, 1.0f);
            mass_color = make_float4(0.29f, 0.48f, 0.60f, 1.0f);
            roof_color = make_float4(0.24f, 0.42f, 0.57f, 1.0f);
            post_color = make_float4(0.29f, 0.32f, 0.36f, 1.0f);
            pad_axis_half = 1.62f;
            pad_cross_half = 0.80f;
            mass_axis_half = 0.18f;
            mass_half_height = 1.18f;
            mass_cross_half = 0.54f;
            roof_axis_half = 1.04f;
            roof_height = 2.16f;
            roof_cross_half = 0.48f;
            post_axis_offset = 0.58f;
            post_cross_shift = 0.12f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.28f, 0.28f, 0.29f, 1.0f);
            seam_color = make_float4(0.21f, 0.21f, 0.22f, 1.0f);
            mass_color = make_float4(0.40f, 0.38f, 0.34f, 1.0f);
            roof_color = make_float4(0.32f, 0.30f, 0.27f, 1.0f);
            post_color = make_float4(0.29f, 0.28f, 0.26f, 1.0f);
            pad_axis_half = 1.82f;
            pad_cross_half = 0.86f;
            mass_axis_half = 1.78f;
            mass_half_height = 1.02f;
            mass_cross_half = 0.10f;
            roof_axis_half = 1.34f;
            roof_height = 1.92f;
            roof_cross_half = 0.18f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.43f, 0.40f, 0.37f, 1.0f);
            seam_color = make_float4(0.29f, 0.27f, 0.24f, 1.0f);
            mass_color = make_float4(0.55f, 0.46f, 0.40f, 1.0f);
            roof_color = make_float4(0.46f, 0.28f, 0.22f, 1.0f);
            post_color = make_float4(0.34f, 0.29f, 0.26f, 1.0f);
            pad_axis_half = 1.44f;
            pad_cross_half = 0.74f;
            mass_axis_half = 0.98f;
            mass_half_height = 0.96f;
            mass_cross_half = 0.24f;
            roof_axis_half = 0.88f;
            roof_height = 2.00f;
            roof_cross_half = 0.34f;
            post_axis_offset = 0.60f;
            post_cross_shift = 0.10f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.16f, 1.0f), 0.01f, 0.06f),
        seam_color
    ));
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.66f, -0.08f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.66f, -0.08f).z,
                0.16f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.66f, -0.08f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.76f, 0.70f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.76f, 0.70f).z,
                    0.60f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 infill_panel = offset_outer_route_position(route_context, mass_center, 0.0f, -0.08f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.64f, -0.04f);
                infill_panel.y = kRoadHeight + 0.68f;
                bench.y = kRoadHeight + 0.14f;
                push_prop(
                    infill_panel,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.12f, 0.68f, 0.30f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.30f, 0.14f, 0.10f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 return_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.16f);
                MDTBFloat3 crate = offset_outer_route_position(route_context, pad_center, along_sign * 0.72f, -0.04f);
                return_wall.y = kRoadHeight + 0.44f;
                crate.y = kRoadHeight + 0.24f;
                push_prop(
                    return_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 1.42f, 0.44f, 0.08f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    crate,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.28f, 0.24f, 0.20f),
                    make_float4(0.34f, 0.32f, 0.29f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.05f);
                plinth.y = kRoadHeight + 0.14f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.66f, 0.14f, 0.08f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.60f, -0.08f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.60f, -0.08f).z,
                0.14f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.60f, -0.08f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.82f, -0.08f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.82f, -0.08f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_inner_enclosure(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 roof_center;
    MDTBFloat4 pad_color = make_float4(0.34f, 0.33f, 0.31f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.25f, 0.24f, 0.23f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.46f, 0.42f, 0.38f, 1.0f);
    MDTBFloat4 roof_color = make_float4(0.30f, 0.31f, 0.33f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.32f, 0.31f, 0.29f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.22f;
    float pad_cross_half = 0.64f;
    float mass_axis_half = 0.94f;
    float mass_half_height = 0.88f;
    float mass_cross_half = 0.12f;
    float roof_axis_half = 0.82f;
    float roof_height = 1.88f;
    float roof_cross_half = 0.26f;
    float post_axis_offset = 0.54f;
    float post_cross_shift = 0.06f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_inner_enclosure_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.16f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.04f, 0.12f);
    roof_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.04f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.42f, 0.40f, 0.37f, 1.0f);
            seam_color = make_float4(0.32f, 0.30f, 0.28f, 1.0f);
            mass_color = make_float4(0.54f, 0.50f, 0.45f, 1.0f);
            roof_color = make_float4(0.40f, 0.37f, 0.33f, 1.0f);
            post_color = make_float4(0.45f, 0.40f, 0.35f, 1.0f);
            pad_axis_half = 1.36f;
            pad_cross_half = 0.68f;
            mass_axis_half = 1.16f;
            mass_half_height = 0.38f;
            mass_cross_half = 0.08f;
            roof_axis_half = 1.20f;
            roof_height = 1.78f;
            roof_cross_half = 0.38f;
            post_axis_offset = 0.72f;
            post_cross_shift = 0.10f;
            add_posts = 1;
            add_tree = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.46f, 0.45f, 0.41f, 1.0f);
            seam_color = make_float4(0.30f, 0.31f, 0.33f, 1.0f);
            mass_color = make_float4(0.28f, 0.46f, 0.58f, 1.0f);
            roof_color = make_float4(0.24f, 0.41f, 0.56f, 1.0f);
            post_color = make_float4(0.28f, 0.31f, 0.35f, 1.0f);
            pad_axis_half = 1.44f;
            pad_cross_half = 0.72f;
            mass_axis_half = 0.14f;
            mass_half_height = 1.06f;
            mass_cross_half = 0.44f;
            roof_axis_half = 0.90f;
            roof_height = 2.02f;
            roof_cross_half = 0.40f;
            ...
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.27f, 0.27f, 0.28f, 1.0f);
            seam_color = make_float4(0.20f, 0.20f, 0.21f, 1.0f);
            mass_color = make_float4(0.38f, 0.36f, 0.32f, 1.0f);
            roof_color = make_float4(0.31f, 0.29f, 0.26f, 1.0f);
            post_color = make_float4(0.28f, 0.27f, 0.25f, 1.0f);
            pad_axis_half = 1.64f;
            pad_cross_half = 0.76f;
            mass_axis_half = 1.56f;
            mass_half_height = 0.96f;
            mass_cross_half = 0.08f;
            roof_axis_half = 1.10f;
            roof_height = 1.84f;
            roof_cross_half = 0.14f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.41f, 0.38f, 0.35f, 1.0f);
            seam_color = make_float4(0.28f, 0.26f, 0.23f, 1.0f);
            mass_color = make_float4(0.53f, 0.44f, 0.39f, 1.0f);
            roof_color = make_float4(0.45f, 0.27f, 0.21f, 1.0f);
            post_color = make_float4(0.33f, 0.28f, 0.25f, 1.0f);
            pad_axis_half = 1.28f;
            pad_cross_half = 0.66f;
            mass_axis_half = 0.86f;
            mass_half_height = 0.90f;
            mass_cross_half = 0.20f;
            roof_axis_half = 0.76f;
            roof_height = 1.92f;
            roof_cross_half = 0.28f;
            post_axis_offset = 0.50f;
            post_cross_shift = 0.08f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.14f, 0.9f), 0.01f, 0.06f),
        seam_color
    ));
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.54f, -0.06f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.54f, -0.06f).z,
                0.12f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.54f, -0.06f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.62f, 0.62f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.62f, 0.62f).z,
                    0.54f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 readout = offset_outer_route_position(route_context, mass_center, 0.0f, -0.06f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.48f, -0.02f);
                readout.y = kRoadHeight + 0.60f;
                bench.y = kRoadHeight + 0.12f;
                push_prop(
                    readout,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.10f, 0.60f, 0.22f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.22f, 0.12f, 0.08f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 return_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.12f);
                MDTBFloat3 utility_block = offset_outer_route_position(route_context, pad_center, along_sign * 0.58f, -0.04f);
                return_wall.y = kRoadHeight + 0.38f;
                utility_block.y = kRoadHeight + 0.20f;
                push_prop(
                    return_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 1.12f, 0.38f, 0.08f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    utility_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.22f, 0.20f, 0.16f),
                    make_float4(0.33f, 0.31f, 0.28f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.04f);
                plinth.y = kRoadHeight + 0.12f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.54f, 0.12f, 0.08f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.48f, -0.06f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.48f, -0.06f).z,
                0.10f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.48f, -0.06f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.70f, -0.06f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.70f, -0.06f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_core_backstop(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 cap_center;
    MDTBFloat4 pad_color = make_float4(0.32f, 0.31f, 0.30f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.24f, 0.23f, 0.22f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.44f, 0.40f, 0.36f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.29f, 0.30f, 0.32f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.31f, 0.30f, 0.28f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 1.04f;
    float pad_cross_half = 0.58f;
    float mass_axis_half = 0.78f;
    float mass_half_height = 0.74f;
    float mass_cross_half = 0.10f;
    float cap_axis_half = 0.68f;
    float cap_height = 1.56f;
    float cap_cross_half = 0.22f;
    float post_axis_offset = 0.42f;
    float post_cross_shift = 0.06f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_core_backstop_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.14f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.02f, 0.10f);
    cap_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.02f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.40f, 0.38f, 0.35f, 1.0f);
            seam_color = make_float4(0.30f, 0.28f, 0.26f, 1.0f);
            mass_color = make_float4(0.52f, 0.48f, 0.44f, 1.0f);
            cap_color = make_float4(0.39f, 0.36f, 0.32f, 1.0f);
            post_color = make_float4(0.43f, 0.38f, 0.34f, 1.0f);
            pad_axis_half = 1.18f;
            pad_cross_half = 0.62f;
            mass_axis_half = 0.96f;
            mass_half_height = 0.34f;
            mass_cross_half = 0.08f;
            cap_axis_half = 1.00f;
            cap_height = 1.46f;
            cap_cross_half = 0.34f;
            ...
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.44f, 0.43f, 0.40f, 1.0f);
            seam_color = make_float4(0.29f, 0.30f, 0.32f, 1.0f);
            mass_color = make_float4(0.27f, 0.44f, 0.56f, 1.0f);
            cap_color = make_float4(0.22f, 0.39f, 0.54f, 1.0f);
            post_color = make_float4(0.27f, 0.30f, 0.34f, 1.0f);
            pad_axis_half = 1.20f;
            pad_cross_half = 0.64f;
            mass_axis_half = 0.12f;
            mass_half_height = 0.96f;
            mass_cross_half = 0.34f;
            cap_axis_half = 0.72f;
            cap_height = 1.72f;
            cap_cross_half = 0.30f;
            post_axis_offset = 0.38f;
            post_cross_shift = 0.08f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.26f, 0.26f, 0.27f, 1.0f);
            seam_color = make_float4(0.19f, 0.19f, 0.20f, 1.0f);
            mass_color = make_float4(0.37f, 0.35f, 0.31f, 1.0f);
            cap_color = make_float4(0.30f, 0.28f, 0.25f, 1.0f);
            post_color = make_float4(0.27f, 0.26f, 0.24f, 1.0f);
            pad_axis_half = 1.34f;
            pad_cross_half = 0.70f;
            mass_axis_half = 1.28f;
            mass_half_height = 0.84f;
            mass_cross_half = 0.08f;
            cap_axis_half = 0.90f;
            cap_height = 1.58f;
            cap_cross_half = 0.12f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.39f, 0.36f, 0.33f, 1.0f);
            seam_color = make_float4(0.27f, 0.25f, 0.22f, 1.0f);
            mass_color = make_float4(0.51f, 0.42f, 0.37f, 1.0f);
            cap_color = make_float4(0.43f, 0.26f, 0.20f, 1.0f);
            post_color = make_float4(0.32f, 0.27f, 0.24f, 1.0f);
            pad_axis_half = 1.08f;
            pad_cross_half = 0.60f;
            mass_axis_half = 0.74f;
            mass_half_height = 0.80f;
            mass_cross_half = 0.18f;
            cap_axis_half = 0.60f;
            cap_height = 1.60f;
            cap_cross_half = 0.24f;
            post_axis_offset = 0.42f;
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.12f, 0.8f), 0.01f, 0.05f),
        seam_color
    ));
    ...
    push_prop(
        cap_center,
        oriented_half_extents_for_axis(route_context->branch_axis, cap_axis_half, 0.07f, cap_cross_half),
        cap_color,
        0
    );
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            {
                MDTBFloat3 back_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.10f);
                back_wall.y = kRoadHeight + 0.24f;
                push_prop(
                    back_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.82f, 0.24f, 0.06f),
                    scaled_color(mass_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.40f, -0.04f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.40f, -0.04f).z,
                0.10f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.40f, -0.04f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.44f, 0.54f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.44f, 0.54f).z,
                    0.46f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 readout = offset_outer_route_position(route_context, mass_center, 0.0f, -0.04f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.38f, -0.02f);
                readout.y = kRoadHeight + 0.54f;
                bench.y = kRoadHeight + 0.10f;
                push_prop(
                    readout,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.08f, 0.54f, 0.18f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.18f, 0.10f, 0.06f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 interior_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.10f);
                MDTBFloat3 equipment_block = offset_outer_route_position(route_context, pad_center, along_sign * 0.44f, -0.04f);
                interior_wall.y = kRoadHeight + 0.34f;
                equipment_block.y = kRoadHeight + 0.18f;
                push_prop(
                    interior_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.96f, 0.34f, 0.08f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    equipment_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.18f, 0.18f, 0.14f),
                    make_float4(0.32f, 0.30f, 0.27f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.04f);
                MDTBFloat3 court_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.08f);
                plinth.y = kRoadHeight + 0.10f;
                court_wall.y = kRoadHeight + 0.30f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.42f, 0.10f, 0.08f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
                push_prop(
                    court_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.62f, 0.30f, 0.06f),
                    scaled_color(cap_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.34f, -0.04f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.34f, -0.04f).z,
                0.08f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.34f, -0.04f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.56f, -0.05f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.56f, -0.05f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}
...
static void build_outer_route_terminal_enclosure(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 cap_center;
    MDTBFloat4 pad_color = make_float4(0.28f, 0.27f, 0.26f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.21f, 0.20f, 0.19f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.40f, 0.37f, 0.33f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.27f, 0.28f, 0.30f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.29f, 0.28f, 0.26f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 0.82f;
    float pad_cross_half = 0.46f;
    float mass_axis_half = 0.56f;
    float mass_half_height = 0.54f;
    float mass_cross_half = 0.07f;
    float cap_axis_half = 0.46f;
    float cap_height = 1.22f;
    float cap_cross_half = 0.15f;
    float post_axis_offset = 0.24f;
    float post_cross_shift = 0.03f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_terminal_enclosure_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.10f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.01f, 0.06f);
    cap_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.01f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.36f, 0.34f, 0.31f, 1.0f);
            seam_color = make_float4(0.28f, 0.26f, 0.24f, 1.0f);
            mass_color = make_float4(0.48f, 0.44f, 0.40f, 1.0f);
            cap_color = make_float4(0.35f, 0.32f, 0.29f, 1.0f);
            post_color = make_float4(0.39f, 0.34f, 0.30f, 1.0f);
            pad_axis_half = 0.92f;
            pad_cross_half = 0.50f;
            mass_axis_half = 0.70f;
            mass_half_height = 0.26f;
            mass_cross_half = 0.06f;
            cap_axis_half = 0.76f;
            cap_height = 1.12f;
            cap_cross_half = 0.22f;
            post_axis_offset = 0.38f;
            post_cross_shift = 0.05f;
            add_posts = 1;
            add_tree = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.40f, 0.39f, 0.36f, 1.0f);
            seam_color = make_float4(0.27f, 0.28f, 0.30f, 1.0f);
            mass_color = make_float4(0.25f, 0.40f, 0.52f, 1.0f);
            cap_color = make_float4(0.20f, 0.35f, 0.48f, 1.0f);
            post_color = make_float4(0.25f, 0.28f, 0.32f, 1.0f);
            pad_axis_half = 0.94f;
            pad_cross_half = 0.52f;
            mass_axis_half = 0.08f;
            mass_half_height = 0.76f;
            mass_cross_half = 0.22f;
            cap_axis_half = 0.50f;
            cap_height = 1.36f;
            cap_cross_half = 0.20f;
            post_axis_offset = 0.22f;
            post_cross_shift = 0.05f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.24f, 0.24f, 0.25f, 1.0f);
            seam_color = make_float4(0.17f, 0.17f, 0.18f, 1.0f);
            mass_color = make_float4(0.33f, 0.31f, 0.28f, 1.0f);
            cap_color = make_float4(0.28f, 0.26f, 0.23f, 1.0f);
            post_color = make_float4(0.25f, 0.24f, 0.22f, 1.0f);
            pad_axis_half = 1.04f;
            pad_cross_half = 0.56f;
            mass_axis_half = 0.96f;
            mass_half_height = 0.62f;
            mass_cross_half = 0.06f;
            cap_axis_half = 0.66f;
            cap_height = 1.24f;
            cap_cross_half = 0.09f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.35f, 0.32f, 0.29f, 1.0f);
            seam_color = make_float4(0.25f, 0.23f, 0.20f, 1.0f);
            mass_color = make_float4(0.47f, 0.38f, 0.33f, 1.0f);
            cap_color = make_float4(0.39f, 0.24f, 0.18f, 1.0f);
            post_color = make_float4(0.30f, 0.25f, 0.22f, 1.0f);
            pad_axis_half = 0.86f;
            pad_cross_half = 0.48f;
            mass_axis_half = 0.52f;
            mass_half_height = 0.60f;
            mass_cross_half = 0.11f;
            cap_axis_half = 0.40f;
            cap_height = 1.28f;
            cap_cross_half = 0.17f;
            post_axis_offset = 0.26f;
            post_cross_shift = 0.03f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.08f, 0.6f), 0.01f, 0.04f),
        seam_color
    ));
    ...
    push_prop(
        cap_center,
        oriented_half_extents_for_axis(route_context->branch_axis, cap_axis_half, 0.05f, cap_cross_half),
        cap_color,
        0
    );
    ...
    if (add_posts) {
        ...
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.03f, cap_height * 0.5f, 0.03f),
            post_color,
            1
        );
        push_prop(
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            {
                MDTBFloat3 court_end = offset_outer_route_position(route_context, mass_center, 0.0f, 0.06f);
                court_end.y = kRoadHeight + 0.16f;
                push_prop(
                    court_end,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.54f, 0.16f, 0.04f),
                    scaled_color(mass_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.20f, -0.03f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.20f, -0.03f).z,
                0.06f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.20f, -0.03f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.22f, 0.38f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.22f, 0.38f).z,
                    0.32f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 readout_post = offset_outer_route_position(route_context, mass_center, 0.0f, -0.02f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.20f, -0.01f);
                readout_post.y = kRoadHeight + 0.42f;
                bench.y = kRoadHeight + 0.07f;
                push_prop(
                    readout_post,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.05f, 0.42f, 0.10f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.10f, 0.07f, 0.04f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 terminal_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.06f);
                MDTBFloat3 cabinet = offset_outer_route_position(route_context, pad_center, along_sign * 0.24f, -0.02f);
                terminal_wall.y = kRoadHeight + 0.24f;
                cabinet.y = kRoadHeight + 0.14f;
                push_prop(
                    terminal_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.62f, 0.24f, 0.05f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    cabinet,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.10f, 0.14f, 0.10f),
                    make_float4(0.30f, 0.28f, 0.25f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.02f);
                MDTBFloat3 end_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.05f);
                plinth.y = kRoadHeight + 0.06f;
                end_wall.y = kRoadHeight + 0.20f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.24f, 0.06f, 0.05f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
                push_prop(
                    end_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.36f, 0.20f, 0.04f),
                    scaled_color(cap_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.16f, -0.03f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.16f, -0.03f).z,
                0.05f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.16f, -0.03f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.32f, -0.03f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.32f, -0.03f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_yard_tail_detail(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 cap_center;
    MDTBFloat4 pad_color = make_float4(0.26f, 0.25f, 0.24f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.19f, 0.18f, 0.17f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.38f, 0.35f, 0.31f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.26f, 0.27f, 0.29f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.28f, 0.27f, 0.25f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 0.72f;
    float pad_cross_half = 0.40f;
    float mass_axis_half = 0.46f;
    float mass_half_height = 0.44f;
    float mass_cross_half = 0.06f;
    float cap_axis_half = 0.36f;
    float cap_height = 1.04f;
    float cap_cross_half = 0.12f;
    float post_axis_offset = 0.18f;
    float post_cross_shift = 0.02f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_yard_tail_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.08f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.01f, 0.05f);
    cap_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.01f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.34f, 0.32f, 0.29f, 1.0f);
            seam_color = make_float4(0.26f, 0.24f, 0.22f, 1.0f);
            mass_color = make_float4(0.46f, 0.42f, 0.38f, 1.0f);
            cap_color = make_float4(0.33f, 0.30f, 0.27f, 1.0f);
            post_color = make_float4(0.37f, 0.32f, 0.28f, 1.0f);
            pad_axis_half = 0.80f;
            pad_cross_half = 0.44f;
            mass_axis_half = 0.58f;
            mass_half_height = 0.22f;
            mass_cross_half = 0.05f;
            cap_axis_half = 0.64f;
            cap_height = 0.96f;
            cap_cross_half = 0.18f;
            post_axis_offset = 0.28f;
            post_cross_shift = 0.04f;
            add_posts = 1;
            add_tree = 1;
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.38f, 0.37f, 0.34f, 1.0f);
            seam_color = make_float4(0.26f, 0.27f, 0.29f, 1.0f);
            mass_color = make_float4(0.24f, 0.38f, 0.50f, 1.0f);
            cap_color = make_float4(0.19f, 0.33f, 0.46f, 1.0f);
            post_color = make_float4(0.24f, 0.27f, 0.31f, 1.0f);
            pad_axis_half = 0.82f;
            pad_cross_half = 0.46f;
            mass_axis_half = 0.06f;
            mass_half_height = 0.66f;
            mass_cross_half = 0.18f;
            cap_axis_half = 0.40f;
            cap_height = 1.18f;
            cap_cross_half = 0.16f;
            post_axis_offset = 0.16f;
            post_cross_shift = 0.04f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.23f, 0.23f, 0.24f, 1.0f);
            seam_color = make_float4(0.16f, 0.16f, 0.17f, 1.0f);
            mass_color = make_float4(0.31f, 0.29f, 0.26f, 1.0f);
            cap_color = make_float4(0.27f, 0.25f, 0.22f, 1.0f);
            post_color = make_float4(0.24f, 0.23f, 0.21f, 1.0f);
            pad_axis_half = 0.90f;
            pad_cross_half = 0.50f;
            mass_axis_half = 0.84f;
            mass_half_height = 0.52f;
            mass_cross_half = 0.05f;
            cap_axis_half = 0.54f;
            cap_height = 1.08f;
            cap_cross_half = 0.08f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.33f, 0.30f, 0.27f, 1.0f);
            seam_color = make_float4(0.24f, 0.22f, 0.19f, 1.0f);
            mass_color = make_float4(0.45f, 0.36f, 0.31f, 1.0f);
            cap_color = make_float4(0.37f, 0.22f, 0.17f, 1.0f);
            post_color = make_float4(0.29f, 0.24f, 0.21f, 1.0f);
            pad_axis_half = 0.76f;
            pad_cross_half = 0.42f;
            mass_axis_half = 0.42f;
            mass_half_height = 0.50f;
            mass_cross_half = 0.09f;
            cap_axis_half = 0.30f;
            cap_height = 1.10f;
            cap_cross_half = 0.14f;
            post_axis_offset = 0.20f;
            post_cross_shift = 0.02f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.06f, 0.5f), 0.01f, 0.04f),
        seam_color
    ));
    ...
    push_prop(
        cap_center,
        oriented_half_extents_for_axis(route_context->branch_axis, cap_axis_half, 0.04f, cap_cross_half),
        cap_color,
        0
    );
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            {
                MDTBFloat3 end_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.04f);
                end_wall.y = kRoadHeight + 0.12f;
                push_prop(
                    end_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.42f, 0.12f, 0.03f),
                    scaled_color(mass_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.14f, -0.02f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.14f, -0.02f).z,
                0.04f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.14f, -0.02f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.16f, 0.30f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.16f, 0.30f).z,
                    0.26f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 terminal_post = offset_outer_route_position(route_context, mass_center, 0.0f, -0.02f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.14f, -0.01f);
                terminal_post.y = kRoadHeight + 0.36f;
                bench.y = kRoadHeight + 0.06f;
                push_prop(
                    terminal_post,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.04f, 0.36f, 0.08f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.08f, 0.06f, 0.03f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 terminal_block = offset_outer_route_position(route_context, mass_center, 0.0f, 0.04f);
                MDTBFloat3 cabinet = offset_outer_route_position(route_context, pad_center, along_sign * 0.18f, -0.02f);
                terminal_block.y = kRoadHeight + 0.18f;
                cabinet.y = kRoadHeight + 0.12f;
                push_prop(
                    terminal_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.48f, 0.18f, 0.04f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    cabinet,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.08f, 0.12f, 0.08f),
                    make_float4(0.29f, 0.27f, 0.24f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.02f);
                MDTBFloat3 end_detail = offset_outer_route_position(route_context, mass_center, 0.0f, 0.04f);
                plinth.y = kRoadHeight + 0.05f;
                end_detail.y = kRoadHeight + 0.16f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.18f, 0.05f, 0.04f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
                push_prop(
                    end_detail,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.28f, 0.16f, 0.03f),
                    scaled_color(cap_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.12f, -0.02f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.12f, -0.02f).z,
                0.03f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.12f, -0.02f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.24f, -0.02f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.24f, -0.02f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}

static void build_outer_route_tail_cap_detail(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    MDTBFloat3 pad_center;
    MDTBFloat3 seam_center;
    MDTBFloat3 mass_center;
    MDTBFloat3 cap_center;
    MDTBFloat4 pad_color = make_float4(0.24f, 0.23f, 0.22f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.18f, 0.17f, 0.16f, 1.0f);
    MDTBFloat4 mass_color = make_float4(0.36f, 0.33f, 0.29f, 1.0f);
    MDTBFloat4 cap_color = make_float4(0.25f, 0.26f, 0.28f, 1.0f);
    MDTBFloat4 post_color = make_float4(0.27f, 0.26f, 0.24f, 1.0f);
    const float along_sign = outer_route_longitudinal_sign_for_block(block);
    float pad_axis_half = 0.62f;
    float pad_cross_half = 0.34f;
    float mass_axis_half = 0.38f;
    float mass_half_height = 0.34f;
    float mass_cross_half = 0.05f;
    float cap_axis_half = 0.28f;
    float cap_height = 0.88f;
    float cap_cross_half = 0.10f;
    float post_axis_offset = 0.12f;
    float post_cross_shift = 0.02f;
    int add_posts = 0;
    int add_tree = 0;
    int add_bollards = 0;
    ...
    pad_center = outer_route_tail_cap_position(block, route_context);
    seam_center = offset_outer_route_position(route_context, pad_center, 0.0f, -0.06f);
    mass_center = offset_outer_route_position(route_context, pad_center, along_sign * 0.01f, 0.04f);
    cap_center = offset_outer_route_position(route_context, mass_center, 0.0f, -0.01f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            pad_color = make_float4(0.32f, 0.30f, 0.27f, 1.0f);
            seam_color = make_float4(0.24f, 0.22f, 0.20f, 1.0f);
            mass_color = make_float4(0.44f, 0.40f, 0.36f, 1.0f);
            cap_color = make_float4(0.31f, 0.28f, 0.25f, 1.0f);
            post_color = make_float4(0.35f, 0.30f, 0.26f, 1.0f);
            pad_axis_half = 0.68f;
            pad_cross_half = 0.38f;
            mass_axis_half = 0.48f;
            mass_half_height = 0.18f;
            mass_cross_half = 0.04f;
            cap_axis_half = 0.54f;
            cap_height = 0.80f;
            cap_cross_half = 0.14f;
            post_axis_offset = 0.20f;
            ...
            break;
        case MDTBFrontageTemplateTransitMarket:
            pad_color = make_float4(0.36f, 0.35f, 0.32f, 1.0f);
            seam_color = make_float4(0.25f, 0.26f, 0.28f, 1.0f);
            mass_color = make_float4(0.23f, 0.36f, 0.48f, 1.0f);
            cap_color = make_float4(0.18f, 0.31f, 0.44f, 1.0f);
            post_color = make_float4(0.23f, 0.26f, 0.30f, 1.0f);
            pad_axis_half = 0.70f;
            pad_cross_half = 0.40f;
            mass_axis_half = 0.05f;
            mass_half_height = 0.56f;
            mass_cross_half = 0.14f;
            cap_axis_half = 0.32f;
            cap_height = 1.00f;
            cap_cross_half = 0.12f;
            post_axis_offset = 0.10f;
            post_cross_shift = 0.03f;
            add_posts = 1;
            break;
        case MDTBFrontageTemplateServiceSpur:
            pad_color = make_float4(0.22f, 0.22f, 0.23f, 1.0f);
            seam_color = make_float4(0.15f, 0.15f, 0.16f, 1.0f);
            mass_color = make_float4(0.29f, 0.27f, 0.24f, 1.0f);
            cap_color = make_float4(0.26f, 0.24f, 0.21f, 1.0f);
            post_color = make_float4(0.23f, 0.22f, 0.20f, 1.0f);
            pad_axis_half = 0.76f;
            pad_cross_half = 0.44f;
            mass_axis_half = 0.70f;
            mass_half_height = 0.42f;
            ...
            cap_axis_half = 0.42f;
            cap_height = 0.92f;
            cap_cross_half = 0.06f;
            add_bollards = 1;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            pad_color = make_float4(0.31f, 0.28f, 0.25f, 1.0f);
            seam_color = make_float4(0.23f, 0.21f, 0.18f, 1.0f);
            mass_color = make_float4(0.43f, 0.34f, 0.29f, 1.0f);
            cap_color = make_float4(0.35f, 0.20f, 0.16f, 1.0f);
            post_color = make_float4(0.28f, 0.23f, 0.20f, 1.0f);
            pad_axis_half = 0.64f;
            pad_cross_half = 0.36f;
            mass_axis_half = 0.34f;
            mass_half_height = 0.40f;
            mass_cross_half = 0.07f;
            cap_axis_half = 0.24f;
            cap_height = 0.94f;
            cap_cross_half = 0.10f;
            post_axis_offset = 0.14f;
            post_cross_shift = 0.02f;
            add_posts = 1;
            break;
    }
    ...
    push_scene_box(make_box(
        make_float3(seam_center.x, kRoadHeight + 0.02f, seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(pad_axis_half - 0.05f, 0.4f), 0.01f, 0.03f),
        seam_color
    ));
    ...
    if (add_posts) {
        ...
        push_prop(
            left_post,
            oriented_half_extents_for_axis(route_context->branch_axis, 0.02f, cap_height * 0.5f, 0.02f),
            post_color,
            1
        );
        push_prop(
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            {
                MDTBFloat3 cap_wall = offset_outer_route_position(route_context, mass_center, 0.0f, 0.03f);
                cap_wall.y = kRoadHeight + 0.10f;
                push_prop(
                    cap_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.30f, 0.10f, 0.03f),
                    scaled_color(mass_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.10f, -0.02f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.10f, -0.02f).z,
                0.03f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.10f, -0.02f).x,
            ...
            if (add_tree) {
                push_tree(
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.10f, 0.24f).x,
                    offset_outer_route_position(route_context, pad_center, along_sign * 0.10f, 0.24f).z,
                    0.20f
                );
            }
            break;
        case MDTBFrontageTemplateTransitMarket:
            {
                MDTBFloat3 cap_post = offset_outer_route_position(route_context, mass_center, 0.0f, -0.01f);
                MDTBFloat3 bench = offset_outer_route_position(route_context, pad_center, -along_sign * 0.10f, -0.01f);
                cap_post.y = kRoadHeight + 0.30f;
                bench.y = kRoadHeight + 0.05f;
                push_prop(
                    cap_post,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.03f, 0.30f, 0.06f),
                    make_float4(0.84f, 0.80f, 0.72f, 1.0f),
                    1
                );
                push_prop(
                    bench,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.06f, 0.05f, 0.02f),
                    make_float4(0.86f, 0.82f, 0.74f, 1.0f),
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 kit_block = offset_outer_route_position(route_context, mass_center, 0.0f, 0.03f);
                MDTBFloat3 cabinet = offset_outer_route_position(route_context, pad_center, along_sign * 0.12f, -0.01f);
                kit_block.y = kRoadHeight + 0.14f;
                cabinet.y = kRoadHeight + 0.10f;
                push_prop(
                    kit_block,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.34f, 0.14f, 0.03f),
                    scaled_color(mass_color, 0.84f),
                    1
                );
                push_prop(
                    cabinet,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.06f, 0.10f, 0.06f),
                    make_float4(0.28f, 0.26f, 0.23f, 1.0f),
                    1
                );
            }
            break;
        ...
        default:
            {
                MDTBFloat3 plinth = offset_outer_route_position(route_context, pad_center, 0.0f, -0.01f);
                MDTBFloat3 cap_detail = offset_outer_route_position(route_context, mass_center, 0.0f, 0.03f);
                plinth.y = kRoadHeight + 0.04f;
                cap_detail.y = kRoadHeight + 0.12f;
                push_prop(
                    plinth,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.12f, 0.04f, 0.03f),
                    scaled_color(mass_color, 0.90f),
                    1
                );
                push_prop(
                    cap_detail,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.20f, 0.12f, 0.03f),
                    scaled_color(cap_color, 0.88f),
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.08f, -0.01f).x,
                offset_outer_route_position(route_context, pad_center, -along_sign * 0.08f, -0.01f).z,
                0.02f
            );
            push_planter(
                offset_outer_route_position(route_context, pad_center, along_sign * 0.08f, -0.01f).x,
    ...
    if (add_bollards) {
        MDTBFloat3 left_bollard = offset_outer_route_position(route_context, pad_center, -along_sign * 0.18f, -0.01f);
        MDTBFloat3 right_bollard = offset_outer_route_position(route_context, pad_center, along_sign * 0.18f, -0.01f);
        push_bollard(left_bollard.x, left_bollard.z, 0.92f);
        push_bollard(right_bollard.x, right_bollard.z, 0.92f);
    }
}
...
static void build_outer_route_lot_composition(const MDTBBlockDescriptor *block, const MDTBOuterRouteNodeContext *route_context) {
    ...
    MDTBFloat3 inner_seam_center;
    MDTBFloat4 lot_color = make_float4(0.42f, 0.40f, 0.36f, 1.0f);
    MDTBFloat4 edge_color = make_float4(0.62f, 0.59f, 0.54f, 1.0f);
    MDTBFloat4 seam_color = make_float4(0.30f, 0.29f, 0.27f, 1.0f);
    MDTBFloat4 wall_color = make_float4(0.52f, 0.47f, 0.42f, 1.0f);
    float lot_axis_half = 2.9f;
    float lot_cross_half = 1.72f;
    float edge_height = 0.34f;
    float edge_axis_half = 2.5f;
    float edge_thickness = 0.08f;
    float along_sign = 1.0f;

    if (block == NULL || route_context == NULL) {
        return;
    }

    along_sign = ((block->variant & 1u) != 0u) ? 1.0f : -1.0f;
    lot_center = offset_outer_route_position(route_context, route_context->support_position, along_sign * 0.36f, 2.10f);
    edge_center = offset_outer_route_position(route_context, lot_center, 0.0f, 1.10f);
    inner_seam_center = offset_outer_route_position(route_context, lot_center, along_sign * 0.22f, -0.26f);

    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            lot_color = make_float4(0.48f, 0.46f, 0.42f, 1.0f);
            edge_color = make_float4(0.74f, 0.71f, 0.66f, 1.0f);
            seam_color = make_float4(0.36f, 0.35f, 0.33f, 1.0f);
            wall_color = make_float4(0.58f, 0.53f, 0.48f, 1.0f);
            lot_axis_half = 2.8f;
            lot_cross_half = 1.84f;
            edge_height = 0.30f;
            break;
        case MDTBFrontageTemplateTransitMarket:
            lot_color = make_float4(0.53f, 0.51f, 0.47f, 1.0f);
            edge_color = make_float4(0.72f, 0.70f, 0.67f, 1.0f);
            seam_color = make_float4(0.33f, 0.34f, 0.36f, 1.0f);
            wall_color = make_float4(0.34f, 0.47f, 0.58f, 1.0f);
            lot_axis_half = 3.2f;
            lot_cross_half = 1.92f;
            edge_height = 0.38f;
            edge_axis_half = 2.8f;
            break;
        case MDTBFrontageTemplateServiceSpur:
            lot_color = make_float4(0.30f, 0.30f, 0.31f, 1.0f);
            edge_color = make_float4(0.58f, 0.56f, 0.52f, 1.0f);
            seam_color = make_float4(0.22f, 0.22f, 0.23f, 1.0f);
            wall_color = make_float4(0.42f, 0.40f, 0.36f, 1.0f);
            lot_axis_half = 3.4f;
            lot_cross_half = 2.06f;
            edge_height = 0.56f;
            edge_axis_half = 3.0f;
            edge_thickness = 0.10f;
            break;
        case MDTBFrontageTemplateCivicRetail:
        default:
            lot_color = make_float4(0.46f, 0.43f, 0.39f, 1.0f);
            edge_color = make_float4(0.69f, 0.65f, 0.60f, 1.0f);
            seam_color = make_float4(0.31f, 0.28f, 0.25f, 1.0f);
            wall_color = make_float4(0.60f, 0.49f, 0.42f, 1.0f);
            lot_axis_half = 3.0f;
            lot_cross_half = 1.82f;
            edge_height = 0.34f;
            break;
    }

    push_scene_box(make_box(
        make_float3(lot_center.x, kRoadHeight + 0.015f, lot_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, lot_axis_half, 0.015f, lot_cross_half),
        lot_color
    ));
    push_scene_box(make_box(
        make_float3(edge_center.x, kRoadHeight + edge_height, edge_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, edge_axis_half, edge_height, edge_thickness),
        edge_color
    ));
    push_scene_box(make_box(
        make_float3(inner_seam_center.x, kRoadHeight + 0.02f, inner_seam_center.z),
        oriented_half_extents_for_axis(route_context->branch_axis, fmaxf(lot_axis_half - 0.46f, 1.2f), 0.01f, 0.06f),
        seam_color
    ));
    ...
    switch (block->frontage_template) {
        case MDTBFrontageTemplateResidentialCourt:
            {
                MDTBFloat3 fence_left = offset_outer_route_position(route_context, lot_center, -along_sign * 1.42f, 0.44f);
                MDTBFloat3 fence_right = offset_outer_route_position(route_context, lot_center, along_sign * 1.42f, 0.44f);
                fence_left.y = kRoadHeight + 0.26f;
                fence_right.y = kRoadHeight + 0.26f;
                push_prop(
                    fence_left,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.54f, 0.26f, 0.06f),
                    wall_color,
                    1
                );
                push_prop(
            ...
            push_tree(
                offset_outer_route_position(route_context, route_context->marker_position, along_sign * 1.30f, 2.78f).x,
                offset_outer_route_position(route_context, route_context->marker_position, along_sign * 1.30f, 2.78f).z,
                0.82f
            );
            break;
        case MDTBFrontageTemplateTransitMarket:
            push_scene_box(make_box(
                offset_outer_route_position(route_context, lot_center, -along_sign * 0.88f, -0.18f),
                oriented_half_extents_for_axis(route_context->branch_axis, 0.56f, 0.01f, 0.06f),
                make_float4(0.88f, 0.84f, 0.74f, 1.0f)
            ));
            push_scene_box(make_box(
                offset_outer_route_position(route_context, lot_center, along_sign * 0.88f, -0.18f),
                oriented_half_extents_for_axis(route_context->branch_axis, 0.56f, 0.01f, 0.06f),
            ...
            {
                MDTBFloat3 kiosk_post = offset_outer_route_position(route_context, lot_center, along_sign * 1.62f, 0.46f);
                kiosk_post.y = kRoadHeight + 0.62f;
                push_prop(
                    kiosk_post,
                    oriented_half_extents_for_axis(route_context->branch_axis, 0.18f, 0.62f, 0.18f),
                    wall_color,
                    1
                );
            }
        ...
        case MDTBFrontageTemplateServiceSpur:
            {
                MDTBFloat3 screen_wall = offset_outer_route_position(route_context, lot_center, 0.0f, 0.46f);
                screen_wall.y = kRoadHeight + 0.58f;
                push_prop(
                    screen_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 2.14f, 0.58f, 0.08f),
                    wall_color,
                    1
                );
            }
            push_bollard(
                offset_outer_route_position(route_context, lot_center, -along_sign * 1.18f, -0.42f).x,
                offset_outer_route_position(route_context, lot_center, -along_sign * 1.18f, -0.42f).z,
                0.92f
            );
            push_bollard(
                offset_outer_route_position(route_context, lot_center, along_sign * 1.18f, -0.42f).x,
        ...
        default:
            {
                MDTBFloat3 plinth_wall = offset_outer_route_position(route_context, lot_center, 0.0f, 0.34f);
                plinth_wall.y = kRoadHeight + 0.30f;
                push_prop(
                    plinth_wall,
                    oriented_half_extents_for_axis(route_context->branch_axis, 1.18f, 0.30f, 0.08f),
                    wall_color,
                    1
                );
            }
            push_planter(
                offset_outer_route_position(route_context, lot_center, -along_sign * 1.18f, -0.20f).x,
                offset_outer_route_position(route_context, lot_center, -along_sign * 1.18f, -0.20f).z,
                0.34f
            );
            push_planter(
                offset_outer_route_position(route_context, lot_center, along_sign * 1.18f, -0.20f).x,
...
static void build_outer_route_support_props(const MDTBBlockDescriptor *block, uint32_t block_index) {
...

    {
        ...
        build_outer_route_frontage_massing(block, &route_context);
        build_outer_route_lot_composition(block, &route_context);
        build_outer_route_edge_continuity(block, &route_context);
        build_outer_route_secondary_frontage(block, &route_context);
        build_outer_route_rear_edge_structure(block, &route_context);
        build_outer_route_backlot_coverage(block, &route_context);
        ...
        build_outer_route_terminal_enclosure(block, &route_context);
        build_outer_route_yard_tail_detail(block, &route_context);
    ...
    if (block_is_outer_expansion_tile(block) && secondary_connector_profile_for_block(block, &connector_profile)) {
        ...
        if (connector_profile.branch_half_longitudinal > 0.0f && connector_profile.branch_half_lateral > 0.0f) {
            ...
            if (outer_route_node_context_for_block(block, &connector_profile, &route_context)) {
                ...
                MDTBFloat3 parcel_hotspot =
                    offset_outer_route_position(&route_context, route_context.support_position, along_sign * 0.34f, 2.12f);
                MDTBFloat3 parcel_pedestrian =
                    offset_outer_route_position(&route_context, route_context.pad_position, along_sign * 1.08f, 1.34f);
                MDTBFloat3 continuity_hotspot = outer_route_continuity_pad_position(block, &route_context);
                MDTBFloat3 continuity_pedestrian = outer_route_continuity_pull_position(block, &route_context);
                MDTBFloat3 continuity_landmark = outer_route_continuity_landmark_position(block, &route_context);
                MDTBFloat3 secondary_hotspot = outer_route_secondary_frontage_position(block, &route_context);
                MDTBFloat3 secondary_pedestrian = outer_route_secondary_pull_position(block, &route_context);
                MDTBFloat3 secondary_cluster_pedestrian =
                    offset_outer_route_position(&route_context, secondary_pedestrian, -along_sign * 0.72f, -0.34f);
                MDTBFloat3 rear_edge_hotspot = outer_route_rear_edge_position(block, &route_context);
                MDTBFloat3 rear_edge_pedestrian = outer_route_rear_edge_pull_position(block, &route_context);
                MDTBFloat3 rear_edge_cluster_pedestrian =
                    offset_outer_route_position(&route_context, rear_edge_pedestrian, along_sign * 0.58f, -0.30f);
                MDTBFloat3 backlot_hotspot = outer_route_backlot_position(block, &route_context);
                MDTBFloat3 backlot_pedestrian = outer_route_backlot_pull_position(block, &route_context);
                MDTBFloat3 backlot_cluster_pedestrian =
                    offset_outer_route_position(&route_context, backlot_pedestrian, -along_sign * 0.54f, -0.24f);
                MDTBFloat3 infill_hotspot = outer_route_infill_position(block, &route_context);
                MDTBFloat3 infill_pedestrian = outer_route_infill_pull_position(block, &route_context);
                MDTBFloat3 infill_cluster_pedestrian =
                    offset_outer_route_position(&route_context, infill_pedestrian, along_sign * 0.46f, -0.18f);
                MDTBFloat3 inner_enclosure_hotspot = outer_route_inner_enclosure_position(block, &route_context);
                MDTBFloat3 inner_enclosure_pedestrian = outer_route_inner_enclosure_pull_position(block, &route_context);
                MDTBFloat3 inner_enclosure_cluster_pedestrian =
                    offset_outer_route_position(&route_context, inner_enclosure_pedestrian, -along_sign * 0.38f, -0.14f);
                MDTBFloat3 core_backstop_hotspot = outer_route_core_backstop_position(block, &route_context);
                ...
                MDTBFloat3 terminal_enclosure_hotspot = outer_route_terminal_enclosure_position(block, &route_context);
                MDTBFloat3 terminal_enclosure_pedestrian = outer_route_terminal_enclosure_pull_position(block, &route_context);
                MDTBFloat3 terminal_enclosure_cluster_pedestrian =
                    offset_outer_route_position(&route_context, terminal_enclosure_pedestrian, along_sign * 0.18f, -0.08f);
                MDTBFloat3 yard_tail_hotspot = outer_route_yard_tail_position(block, &route_context);
                MDTBFloat3 yard_tail_pedestrian = outer_route_yard_tail_pull_position(block, &route_context);
                MDTBFloat3 yard_tail_cluster_pedestrian =
                    offset_outer_route_position(&route_context, yard_tail_pedestrian, -along_sign * 0.14f, -0.06f);
                float support_hotspot_radius = 6.6f;
                float marker_hotspot_radius = 6.0f;
                float parcel_hotspot_radius = 5.8f;
                float continuity_hotspot_radius = 5.4f;
                float continuity_landmark_radius = 6.2f;
                float secondary_hotspot_radius = 4.8f;
                float rear_edge_hotspot_radius = 4.2f;
                float backlot_hotspot_radius = 3.6f;
                ...
                float terminal_enclosure_hotspot_radius = 1.6f;
                float yard_tail_hotspot_radius = 1.3f;

                support_hotspot.y = kSidewalkHeight;
                marker_hotspot.y = kSidewalkHeight;
                support_pedestrian.y = kSidewalkHeight;
                parcel_hotspot.y = kSidewalkHeight;
                parcel_pedestrian.y = kSidewalkHeight;
                continuity_hotspot.y = kSidewalkHeight;
                continuity_pedestrian.y = kSidewalkHeight;
                continuity_landmark.y = kSidewalkHeight;
                secondary_hotspot.y = kSidewalkHeight;
                secondary_pedestrian.y = kSidewalkHeight;
                secondary_cluster_pedestrian.y = kSidewalkHeight;
                rear_edge_hotspot.y = kSidewalkHeight;
                rear_edge_pedestrian.y = kSidewalkHeight;
                rear_edge_cluster_pedestrian.y = kSidewalkHeight;
                backlot_hotspot.y = kSidewalkHeight;
                backlot_pedestrian.y = kSidewalkHeight;
                backlot_cluster_pedestrian.y = kSidewalkHeight;
                infill_hotspot.y = kSidewalkHeight;
                infill_pedestrian.y = kSidewalkHeight;
                infill_cluster_pedestrian.y = kSidewalkHeight;
                inner_enclosure_hotspot.y = kSidewalkHeight;
                inner_enclosure_pedestrian.y = kSidewalkHeight;
                inner_enclosure_cluster_pedestrian.y = kSidewalkHeight;
                ...
                terminal_enclosure_hotspot.y = kSidewalkHeight;
                terminal_enclosure_pedestrian.y = kSidewalkHeight;
                terminal_enclosure_cluster_pedestrian.y = kSidewalkHeight;
                yard_tail_hotspot.y = kSidewalkHeight;
                yard_tail_pedestrian.y = kSidewalkHeight;
                yard_tail_cluster_pedestrian.y = kSidewalkHeight;

                switch (block->frontage_template) {
                    case MDTBFrontageTemplateResidentialCourt:
                        support_hotspot_radius = 5.8f;
                        marker_hotspot_radius = 5.4f;
                        parcel_hotspot_radius = 5.2f;
                        continuity_hotspot_radius = 4.8f;
                        continuity_landmark_radius = 5.8f;
                        secondary_hotspot_radius = 4.4f;
                        rear_edge_hotspot_radius = 3.8f;
                        backlot_hotspot_radius = 3.2f;
                        ...
                        terminal_enclosure_hotspot_radius = 1.4f;
                        yard_tail_hotspot_radius = 1.1f;
                        break;
                    case MDTBFrontageTemplateTransitMarket:
                        support_hotspot_radius = 6.8f;
                        marker_hotspot_radius = 6.4f;
                        parcel_hotspot_radius = 6.2f;
                        continuity_hotspot_radius = 6.4f;
                        continuity_landmark_radius = 6.8f;
                        secondary_hotspot_radius = 5.8f;
                        rear_edge_hotspot_radius = 4.8f;
                        backlot_hotspot_radius = 4.2f;
                        ...
                        terminal_enclosure_hotspot_radius = 2.3f;
                        yard_tail_hotspot_radius = 2.0f;
                        break;
                    case MDTBFrontageTemplateServiceSpur:
                        support_hotspot_radius = 6.4f;
                        marker_hotspot_radius = 6.0f;
                        parcel_hotspot_radius = 6.0f;
                        continuity_hotspot_radius = 6.0f;
                        continuity_landmark_radius = 6.4f;
                        secondary_hotspot_radius = 5.4f;
                        rear_edge_hotspot_radius = 4.6f;
                        backlot_hotspot_radius = 4.0f;
                        ...
                        terminal_enclosure_hotspot_radius = 2.1f;
                        yard_tail_hotspot_radius = 1.8f;
                        break;
                    case MDTBFrontageTemplateCivicRetail:
                    default:
                        support_hotspot_radius = 6.6f;
                        marker_hotspot_radius = 6.2f;
                        parcel_hotspot_radius = 5.8f;
                        continuity_hotspot_radius = 5.6f;
                        continuity_landmark_radius = 6.4f;
                        secondary_hotspot_radius = 5.0f;
                        rear_edge_hotspot_radius = 4.4f;
                        backlot_hotspot_radius = 3.8f;
                        ...
                        terminal_enclosure_hotspot_radius = 1.9f;
                        yard_tail_hotspot_radius = 1.6f;
                        break;
                }
                ...
                push_interest_point(parcel_hotspot, parcel_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(parcel_pedestrian, 4.6f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(continuity_hotspot, continuity_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(continuity_pedestrian, 4.4f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(continuity_landmark, continuity_landmark_radius, MDTBInterestPointLandmark, block_index);
                push_interest_point(secondary_hotspot, secondary_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(secondary_pedestrian, 4.2f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(secondary_cluster_pedestrian, 4.0f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(rear_edge_hotspot, rear_edge_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(rear_edge_pedestrian, 3.8f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(rear_edge_cluster_pedestrian, 3.8f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(backlot_hotspot, backlot_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(backlot_pedestrian, 3.6f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(backlot_cluster_pedestrian, 3.4f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(infill_hotspot, infill_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(infill_pedestrian, 3.2f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(infill_cluster_pedestrian, 3.0f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(inner_enclosure_hotspot, inner_enclosure_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(inner_enclosure_pedestrian, 2.8f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(inner_enclosure_cluster_pedestrian, 2.6f, MDTBInterestPointPedestrianSpawn, block_index);
                ...
                push_interest_point(terminal_enclosure_hotspot, terminal_enclosure_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(terminal_enclosure_pedestrian, 1.6f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(terminal_enclosure_cluster_pedestrian, 1.4f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(yard_tail_hotspot, yard_tail_hotspot_radius, MDTBInterestPointHotspot, block_index);
                push_interest_point(yard_tail_pedestrian, 1.3f, MDTBInterestPointPedestrianSpawn, block_index);
                push_interest_point(yard_tail_cluster_pedestrian, 1.1f, MDTBInterestPointPedestrianSpawn, block_index);
            }
        }
    }
}
...
static void build_vehicle_handoff_hooks(const MDTBBlockDescriptor *block, uint32_t block_index) {
    ...
    if (block_is_outer_expansion_tile(block) && secondary_connector_profile_for_block(block, &connector_profile)) {
        ...
        if (connector_profile.branch_half_longitudinal > 0.0f && connector_profile.branch_half_lateral > 0.0f) {
            ...
            float branch_anchor_distance =
                has_route_context
                ? route_context.support_distance - 0.78f
                : branch_center_distance + connector_profile.branch_half_longitudinal * 0.58f;
            float branch_pedestrian_distance =
                has_route_context
                ? route_context.marker_distance + 0.40f
                : branch_center_distance + connector_profile.branch_half_longitudinal + 1.0f;
            float branch_side_shift =
                has_route_context
                ? route_context.support_shift * 0.48f
                : secondary_connector_branch_support_shift(block) * 0.54f;
            ...
            switch (block->frontage_template) {
                case MDTBFrontageTemplateResidentialCourt:
                    ...
                    branch_anchor_distance += has_route_context ? -0.10f : 0.6f;
                    branch_side_shift = has_route_context ? route_context.support_shift * 0.28f : branch_side_shift;
                    break;
                case MDTBFrontageTemplateTransitMarket:
                    branch_kind = MDTBVehicleKindMoped;
                    branch_parking_state = MDTBVehicleParkingStateCurbside;
                    branch_anchor_distance += has_route_context ? 0.18f : 0.0f;
                    branch_pedestrian_distance += has_route_context ? 0.18f : 0.6f;
                    branch_side_shift = has_route_context ? route_context.support_shift * 0.62f : branch_side_shift;
                    break;
                case MDTBFrontageTemplateServiceSpur:
                    branch_kind = MDTBVehicleKindSedan;
                    branch_parking_state = MDTBVehicleParkingStateService;
                    branch_anchor_distance += has_route_context ? 0.48f : 1.0f;
                    branch_pedestrian_distance += has_route_context ? 0.22f : 0.0f;
                    branch_side_shift = has_route_context ? route_context.support_shift * 0.72f : secondary_connector_branch_support_shift(block) * 0.38f;
                    break;
                case MDTBFrontageTemplateCivicRetail:
                default:
                    branch_kind = MDTBVehicleKindCoupe;
                    branch_parking_state = MDTBVehicleParkingStateCurbside;
                    branch_anchor_distance += has_route_context ? 0.12f : 0.0f;
                    branch_side_shift = has_route_context ? route_context.support_shift * 0.52f : branch_side_shift;
                    break;
            }

            {
                ...
                if (has_route_context) {
                    branch_pedestrian.x += (branch_axis == MDTBRoadAxisEastWest ? 0.0f : branch_side_shift);
                    branch_pedestrian.z += (branch_axis == MDTBRoadAxisEastWest ? branch_side_shift : 0.0f);
                }
                ...
                if (has_route_context) {
                    MDTBFloat3 pocket_anchor =
                        offset_outer_route_position(&route_context, route_context.support_position, along_sign * 0.28f, 1.82f);
                    MDTBFloat3 pocket_pedestrian =
                        offset_outer_route_position(&route_context, route_context.pad_position, along_sign * 0.96f, 1.20f);
                    MDTBFloat3 continuity_anchor =
                        offset_outer_route_position(&route_context, outer_route_continuity_pad_position(block, &route_context), along_sign * 0.12f, -0.08f);
                    MDTBFloat3 continuity_pedestrian = outer_route_continuity_pull_position(block, &route_context);
                    MDTBFloat3 secondary_anchor = outer_route_secondary_staging_position(block, &route_context);
                    MDTBFloat3 secondary_pedestrian = outer_route_secondary_pull_position(block, &route_context);
                    MDTBFloat3 rear_edge_anchor = outer_route_rear_edge_staging_position(block, &route_context);
                    MDTBFloat3 rear_edge_pedestrian = outer_route_rear_edge_pull_position(block, &route_context);
                    MDTBFloat3 backlot_anchor = outer_route_backlot_staging_position(block, &route_context);
                    MDTBFloat3 backlot_pedestrian = outer_route_backlot_pull_position(block, &route_context);
                    MDTBFloat3 infill_anchor = outer_route_infill_staging_position(block, &route_context);
                    MDTBFloat3 infill_pedestrian = outer_route_infill_pull_position(block, &route_context);
                    MDTBFloat3 inner_enclosure_anchor = outer_route_inner_enclosure_staging_position(block, &route_context);
                    MDTBFloat3 inner_enclosure_pedestrian = outer_route_inner_enclosure_pull_position(block, &route_context);
                    ...
                    MDTBFloat3 rear_core_pedestrian = outer_route_rear_core_pull_position(block, &route_context);
                    MDTBFloat3 terminal_enclosure_anchor = outer_route_terminal_enclosure_staging_position(block, &route_context);
                    MDTBFloat3 terminal_enclosure_pedestrian = outer_route_terminal_enclosure_pull_position(block, &route_context);
                    MDTBFloat3 yard_tail_anchor = outer_route_yard_tail_staging_position(block, &route_context);
                    MDTBFloat3 yard_tail_pedestrian = outer_route_yard_tail_pull_position(block, &route_context);
                    uint32_t pocket_kind = branch_kind;
                    uint32_t pocket_parking_state = branch_parking_state;
                    uint32_t continuity_kind = branch_kind;
                    uint32_t continuity_parking_state = branch_parking_state;
                    uint32_t secondary_kind = branch_kind;
                    uint32_t secondary_parking_state = branch_parking_state;
                    uint32_t rear_edge_kind = branch_kind;
                    uint32_t rear_edge_parking_state = branch_parking_state;
                    uint32_t backlot_kind = branch_kind;
                    uint32_t backlot_parking_state = branch_parking_state;
                    uint32_t infill_kind = branch_kind;
                    uint32_t infill_parking_state = branch_parking_state;
                    uint32_t inner_enclosure_kind = branch_kind;
                    ...
                    uint32_t terminal_enclosure_kind = branch_kind;
                    uint32_t terminal_enclosure_parking_state = branch_parking_state;
                    uint32_t yard_tail_kind = branch_kind;
                    uint32_t yard_tail_parking_state = branch_parking_state;
                    const float pocket_yaw =
                        branch_axis == MDTBRoadAxisEastWest
                        ? (along_sign >= 0.0f ? kPi * 0.5f : -(kPi * 0.5f))
                        : (along_sign >= 0.0f ? kPi : 0.0f);

                    switch (block->frontage_template) {
                        case MDTBFrontageTemplateResidentialCourt:
                            pocket_kind = MDTBVehicleKindCoupe;
                            pocket_parking_state = MDTBVehicleParkingStateCurbside;
                            continuity_kind = MDTBVehicleKindCoupe;
                            continuity_parking_state = MDTBVehicleParkingStateCurbside;
                            secondary_kind = MDTBVehicleKindBicycle;
                            secondary_parking_state = MDTBVehicleParkingStateCurbside;
                            rear_edge_kind = MDTBVehicleKindCoupe;
                            rear_edge_parking_state = MDTBVehicleParkingStateCurbside;
                            backlot_kind = MDTBVehicleKindBicycle;
                            backlot_parking_state = MDTBVehicleParkingStateCurbside;
                            infill_kind = MDTBVehicleKindBicycle;
                            infill_parking_state = MDTBVehicleParkingStateCurbside;
                            inner_enclosure_kind = MDTBVehicleKindBicycle;
                            ...
                            terminal_enclosure_kind = MDTBVehicleKindBicycle;
                            terminal_enclosure_parking_state = MDTBVehicleParkingStateCurbside;
                            yard_tail_kind = MDTBVehicleKindBicycle;
                            yard_tail_parking_state = MDTBVehicleParkingStateCurbside;
                            break;
                        case MDTBFrontageTemplateTransitMarket:
                            pocket_kind = MDTBVehicleKindMoped;
                            pocket_parking_state = MDTBVehicleParkingStateCurbside;
                            continuity_kind = MDTBVehicleKindMoped;
                            continuity_parking_state = MDTBVehicleParkingStateCurbside;
                            secondary_kind = MDTBVehicleKindMoped;
                            secondary_parking_state = MDTBVehicleParkingStateCurbside;
                            rear_edge_kind = MDTBVehicleKindMoped;
                            rear_edge_parking_state = MDTBVehicleParkingStateCurbside;
                            backlot_kind = MDTBVehicleKindMoped;
                            backlot_parking_state = MDTBVehicleParkingStateCurbside;
                            infill_kind = MDTBVehicleKindMoped;
                            infill_parking_state = MDTBVehicleParkingStateCurbside;
                            inner_enclosure_kind = MDTBVehicleKindMoped;
                            inner_enclosure_parking_state = MDTBVehicleParkingStateCurbside;
                            core_backstop_kind = MDTBVehicleKindMoped;
                            core_backstop_parking_state = MDTBVehicleParkingStateCurbside;
                            rear_core_kind = MDTBVehicleKindMoped;
                            rear_core_parking_state = MDTBVehicleParkingStateCurbside;
                            terminal_enclosure_kind = MDTBVehicleKindMoped;
                            terminal_enclosure_parking_state = MDTBVehicleParkingStateCurbside;
                            yard_tail_kind = MDTBVehicleKindMoped;
                            yard_tail_parking_state = MDTBVehicleParkingStateCurbside;
                            break;
                        case MDTBFrontageTemplateServiceSpur:
                            pocket_kind = MDTBVehicleKindSedan;
                            pocket_parking_state = MDTBVehicleParkingStateService;
                            continuity_kind = MDTBVehicleKindSedan;
                            continuity_parking_state = MDTBVehicleParkingStateService;
                            secondary_kind = MDTBVehicleKindSedan;
                            secondary_parking_state = MDTBVehicleParkingStateService;
                            rear_edge_kind = MDTBVehicleKindSedan;
                            rear_edge_parking_state = MDTBVehicleParkingStateService;
                            backlot_kind = MDTBVehicleKindSedan;
                            backlot_parking_state = MDTBVehicleParkingStateService;
                            infill_kind = MDTBVehicleKindSedan;
                            infill_parking_state = MDTBVehicleParkingStateService;
                            inner_enclosure_kind = MDTBVehicleKindSedan;
                            ...
                            terminal_enclosure_kind = MDTBVehicleKindSedan;
                            terminal_enclosure_parking_state = MDTBVehicleParkingStateService;
                            yard_tail_kind = MDTBVehicleKindSedan;
                            yard_tail_parking_state = MDTBVehicleParkingStateService;
                            break;
                        case MDTBFrontageTemplateCivicRetail:
                        default:
                            pocket_kind = MDTBVehicleKindMotorcycle;
                            pocket_parking_state = MDTBVehicleParkingStateCurbside;
                            continuity_kind = MDTBVehicleKindCoupe;
                            continuity_parking_state = MDTBVehicleParkingStateCurbside;
                            secondary_kind = MDTBVehicleKindMotorcycle;
                            secondary_parking_state = MDTBVehicleParkingStateCurbside;
                            rear_edge_kind = MDTBVehicleKindCoupe;
                            rear_edge_parking_state = MDTBVehicleParkingStateCurbside;
                            backlot_kind = MDTBVehicleKindMotorcycle;
                            backlot_parking_state = MDTBVehicleParkingStateCurbside;
                            infill_kind = MDTBVehicleKindMotorcycle;
                            infill_parking_state = MDTBVehicleParkingStateCurbside;
                            inner_enclosure_kind = MDTBVehicleKindMotorcycle;
                            inner_enclosure_parking_state = MDTBVehicleParkingStateCurbside;
                            core_backstop_kind = MDTBVehicleKindMotorcycle;
                            core_backstop_parking_state = MDTBVehicleParkingStateCurbside;
                            rear_core_kind = MDTBVehicleKindMotorcycle;
                            rear_core_parking_state = MDTBVehicleParkingStateCurbside;
                            terminal_enclosure_kind = MDTBVehicleKindMotorcycle;
                            terminal_enclosure_parking_state = MDTBVehicleParkingStateCurbside;
                            yard_tail_kind = MDTBVehicleKindMotorcycle;
                            yard_tail_parking_state = MDTBVehicleParkingStateCurbside;
                            break;
                    }

                    pocket_pedestrian.y = kSidewalkHeight;
                    continuity_pedestrian.y = kSidewalkHeight;
                    secondary_pedestrian.y = kSidewalkHeight;
                    rear_edge_pedestrian.y = kSidewalkHeight;
                    backlot_pedestrian.y = kSidewalkHeight;
                    ...
                    push_vehicle_anchor(
                        ...
                        block_index,
                        pocket_kind,
                        pocket_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(continuity_anchor, 4.4f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(continuity_pedestrian, 4.2f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        continuity_anchor,
                        pocket_yaw,
                        block_index,
                        continuity_kind,
                        continuity_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(secondary_anchor, 4.0f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(secondary_pedestrian, 4.0f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        secondary_anchor,
                        pocket_yaw,
                        block_index,
                        secondary_kind,
                        secondary_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(rear_edge_anchor, 3.8f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(rear_edge_pedestrian, 3.8f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        rear_edge_anchor,
                        pocket_yaw,
                        block_index,
                        rear_edge_kind,
                        rear_edge_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(backlot_anchor, 3.6f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(backlot_pedestrian, 3.6f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        backlot_anchor,
                        pocket_yaw,
                        block_index,
                        backlot_kind,
                        backlot_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(infill_anchor, 3.4f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(infill_pedestrian, 3.2f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        infill_anchor,
                        pocket_yaw,
                        block_index,
                        infill_kind,
                        infill_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(inner_enclosure_anchor, 3.0f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(inner_enclosure_pedestrian, 2.8f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        inner_enclosure_anchor,
                        pocket_yaw,
                        block_index,
                        inner_enclosure_kind,
                        inner_enclosure_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(core_backstop_anchor, 2.6f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(core_backstop_pedestrian, 2.4f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        core_backstop_anchor,
                        pocket_yaw,
                        block_index,
                        core_backstop_kind,
                    ...
                    push_interest_point(terminal_enclosure_anchor, 1.8f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(terminal_enclosure_pedestrian, 1.6f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        terminal_enclosure_anchor,
                        pocket_yaw,
                        block_index,
                        terminal_enclosure_kind,
                        terminal_enclosure_parking_state,
                        branch_axis,
                        connector_profile.branch_center_offset
                    );
                    push_interest_point(yard_tail_anchor, 1.4f, MDTBInterestPointVehicleSpawn, block_index);
                    push_interest_point(yard_tail_pedestrian, 1.3f, MDTBInterestPointPedestrianSpawn, block_index);
                    push_vehicle_anchor(
                        yard_tail_anchor,
                        pocket_yaw,
